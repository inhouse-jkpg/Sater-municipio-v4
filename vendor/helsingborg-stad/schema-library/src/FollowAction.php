...
use \Municipio\Schema\Contracts\FollowActionContract;
...
class FollowAction extends BaseType implements FollowActionContract, ActionContract, InteractActionContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $followee
     *
     * @return static
     *
