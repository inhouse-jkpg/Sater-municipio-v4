...
use \Municipio\Schema\Contracts\AudioObjectSnapshotContract;
 ...
 *
 */
class AudioObjectSnapshot extends BaseType implements AudioObjectSnapshotContract, AudioObjectContract, CreativeWorkContract, MediaObjectContract, ThingContract
{
    /**
