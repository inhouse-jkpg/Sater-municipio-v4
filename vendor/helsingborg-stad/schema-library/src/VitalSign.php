...
use \Municipio\Schema\Contracts\VitalSignContract;
use \Municipio\Schema\Contracts\MedicalConditionContract;
use \Municipio\Schema\Contracts\MedicalEntityContract;
use \Municipio\Schema\Contracts\MedicalSignContract;
use \Municipio\Schema\Contracts\MedicalSignOrSymptomContract;
...
class VitalSign extends BaseType implements VitalSignContract, MedicalConditionContract, MedicalEntityContract, MedicalSignContract, MedicalSignOrSymptomContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\PhysicalExamContract|\Municipio\Schema\Contracts\PhysicalExamContract[] $identifyingExam
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('identifyingExam', $identifyingExam);
    }

    /**
     * A diagnostic test that can identify this sign.
     *
     * @param \Municipio\Schema\Contracts\MedicalTestContract|\Municipio\Schema\Contracts\MedicalTestContract[] $identifyingTest
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('identifyingTest', $identifyingTest);
    }
