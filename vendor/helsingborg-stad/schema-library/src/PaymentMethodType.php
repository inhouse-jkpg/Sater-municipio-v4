...
use \Municipio\Schema\Contracts\PaymentMethodTypeContract;
 ...
 */
class PaymentMethodType extends BaseType implements PaymentMethodTypeContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
