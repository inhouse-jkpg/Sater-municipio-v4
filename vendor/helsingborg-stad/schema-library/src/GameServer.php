...
use \Municipio\Schema\Contracts\GameServerContract;
...
class GameServer extends BaseType implements GameServerContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\VideoGameContract|\Municipio\Schema\Contracts\VideoGameContract[] $game
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\GameServerStatusContract|\Municipio\Schema\Contracts\GameServerStatusContract[] $serverStatus
     *
     * @return static
     *
