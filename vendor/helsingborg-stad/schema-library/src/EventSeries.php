...
use \Municipio\Schema\Contracts\EventSeriesContract;
 ...
 *
 */
class EventSeries extends BaseType implements EventSeriesContract, EventContract, IntangibleContract, SeriesContract, ThingContract
{
    /**
