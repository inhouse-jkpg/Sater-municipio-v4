...
use \Municipio\Schema\Contracts\ReplaceActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\ThingContract;
use \Municipio\Schema\Contracts\UpdateActionContract;
 ...
 *
 */
class ReplaceAction extends BaseType implements ReplaceActionContract, ActionContract, ThingContract, UpdateActionContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $collection
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $replacee
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $replacer
     *
     * @return static
     *
     ...
     * A sub property of object. The collection target of the action.
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $targetCollection
     *
     * @return static
     *
