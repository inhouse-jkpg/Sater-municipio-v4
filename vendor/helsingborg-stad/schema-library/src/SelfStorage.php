...
use \Municipio\Schema\Contracts\SelfStorageContract;
 ...
 *
 */
class SelfStorage extends BaseType implements SelfStorageContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
