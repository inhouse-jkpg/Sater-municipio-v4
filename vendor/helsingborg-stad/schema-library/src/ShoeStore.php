...
use \Municipio\Schema\Contracts\ShoeStoreContract;
 ...
 *
 */
class ShoeStore extends BaseType implements ShoeStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
