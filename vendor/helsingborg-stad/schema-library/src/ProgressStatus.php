 ...
 * Progress status
 *
 * @see municipio:ProgressStatus
 *
 */
class ProgressStatus extends BaseType implements ProgressStatusContract, ThingContract
{
    /**
     ...
     *
     * @param float|float[]|int|int[] $maxNumber
     *
     * @return static
     *
     * @see municipio:maxNumber
     */
    public function maxNumber($maxNumber)
    {
        return $this->setProperty('maxNumber', $maxNumber);
    }

    /**
     * The minimum number of the progress status.
     *
     * @param float|float[]|int|int[] $minNumber
     *
     * @return static
     *
     * @see municipio:minNumber
     */
    public function minNumber($minNumber)
    {
        return $this->setProperty('minNumber', $minNumber);
    }
     ...
     *
     * @param float|float[]|int|int[] $number
     *
     * @return static
     *
     * @see municipio:number
     */
