...
use \Municipio\Schema\Contracts\TravelAgencyContract;
 ...
 *
 */
class TravelAgency extends BaseType implements TravelAgencyContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
