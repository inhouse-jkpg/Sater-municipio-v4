...
use \Municipio\Schema\Contracts\WarrantyPromiseContract;
...
class WarrantyPromise extends BaseType implements WarrantyPromiseContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $durationOfWarranty
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\WarrantyScopeContract|\Municipio\Schema\Contracts\WarrantyScopeContract[] $warrantyScope
     *
     * @return static
     *
