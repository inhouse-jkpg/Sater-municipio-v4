...
use \Municipio\Schema\Contracts\AuthorizeActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\AllocateActionContract;
use \Municipio\Schema\Contracts\OrganizeActionContract;
 ...
 *
 */
class AuthorizeAction extends BaseType implements AuthorizeActionContract, ActionContract, AllocateActionContract, OrganizeActionContract, ThingContract
{
    /**
