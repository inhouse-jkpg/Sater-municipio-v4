...
use \Municipio\Schema\Contracts\CovidTestingFacilityContract;
use \Municipio\Schema\Contracts\LocalBusinessContract;
use \Municipio\Schema\Contracts\MedicalBusinessContract;
use \Municipio\Schema\Contracts\MedicalClinicContract;
 ...
 *
 */
class CovidTestingFacility extends BaseType implements CovidTestingFacilityContract, LocalBusinessContract, MedicalBusinessContract, MedicalClinicContract, MedicalOrganizationContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
