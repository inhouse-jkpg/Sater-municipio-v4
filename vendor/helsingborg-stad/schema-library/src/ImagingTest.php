...
use \Municipio\Schema\Contracts\ImagingTestContract;
use \Municipio\Schema\Contracts\MedicalEntityContract;
use \Municipio\Schema\Contracts\MedicalTestContract;
...
class ImagingTest extends BaseType implements ImagingTestContract, MedicalEntityContract, MedicalTestContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugContract|\Municipio\Schema\Contracts\DrugContract[] $affectedBy
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalImagingTechniqueContract|\Municipio\Schema\Contracts\MedicalImagingTechniqueContract[] $imagingTechnique
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('imagingTechnique', $imagingTechnique);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalEnumerationContract|\Municipio\Schema\Contracts\MedicalEnumerationContract[]|string|string[] $normalRange
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalSignContract|\Municipio\Schema\Contracts\MedicalSignContract[] $signDetected
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalConditionContract|\Municipio\Schema\Contracts\MedicalConditionContract[] $usedToDiagnose
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalDeviceContract|\Municipio\Schema\Contracts\MedicalDeviceContract[] $usesDevice
     *
     * @return static
     *
