...
use \Municipio\Schema\Contracts\ShippingRateSettingsContract;
...
class ShippingRateSettings extends BaseType implements ShippingRateSettingsContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DeliveryChargeSpecificationContract|\Municipio\Schema\Contracts\DeliveryChargeSpecificationContract[]|\Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[] $freeShippingThreshold
     *
     * @return static
     *
