...
use \Municipio\Schema\Contracts\PaymentChargeSpecificationContract;
...
class PaymentChargeSpecification extends BaseType implements PaymentChargeSpecificationContract, IntangibleContract, PriceSpecificationContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DeliveryMethodContract|\Municipio\Schema\Contracts\DeliveryMethodContract[] $appliesToDeliveryMethod
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PaymentMethodContract|\Municipio\Schema\Contracts\PaymentMethodContract[] $appliesToPaymentMethod
     *
     * @return static
     *
