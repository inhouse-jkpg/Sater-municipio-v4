...
use \Municipio\Schema\Contracts\MedicalRiskFactorContract;
...
class MedicalRiskFactor extends BaseType implements MedicalRiskFactorContract, MedicalEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalEntityContract|\Municipio\Schema\Contracts\MedicalEntityContract[] $increasesRiskOf
     *
     * @return static
     *
