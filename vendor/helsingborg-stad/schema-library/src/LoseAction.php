...
use \Municipio\Schema\Contracts\LoseActionContract;
use \Municipio\Schema\Contracts\AchieveActionContract;
 ...
 *
 */
class LoseAction extends BaseType implements LoseActionContract, AchieveActionContract, ActionContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $winner
     *
     * @return static
     *
