...
use \Municipio\Schema\Contracts\DiagnosticLabContract;
...
class DiagnosticLab extends BaseType implements DiagnosticLabContract, MedicalOrganizationContract, OrganizationContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalTestContract|\Municipio\Schema\Contracts\MedicalTestContract[] $availableTest
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('availableTest', $availableTest);
    }
