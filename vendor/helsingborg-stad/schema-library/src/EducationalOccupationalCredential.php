...
use \Municipio\Schema\Contracts\EducationalOccupationalCredentialContract;
 ...
 *
 */
class EducationalOccupationalCredential extends BaseType implements EducationalOccupationalCredentialContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[]|string|string[] $credentialCategory
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('credentialCategory', $credentialCategory);
    }
     ...
     * or accreditation.
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $recognizedBy
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/1779
     */
    public function recognizedBy($recognizedBy)
    {
        return $this->setProperty('recognizedBy', $recognizedBy);
    }
