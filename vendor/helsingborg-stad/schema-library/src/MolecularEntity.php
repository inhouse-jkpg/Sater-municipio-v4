...
use \Municipio\Schema\Contracts\MolecularEntityContract;
...
class MolecularEntity extends BaseType implements MolecularEntityContract, BioChemEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[] $chemicalRole
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|string|string[] $molecularWeight
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|string|string[] $monoisotopicMolecularWeight
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[] $potentialUse
     *
     * @return static
     *
