...
use \Municipio\Schema\Contracts\FloristContract;
 ...
 *
 */
class Florist extends BaseType implements FloristContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
