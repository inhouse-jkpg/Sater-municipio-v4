...
use \Municipio\Schema\Contracts\NonprofitTypeContract;
 ...
 */
class NonprofitType extends BaseType implements NonprofitTypeContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
