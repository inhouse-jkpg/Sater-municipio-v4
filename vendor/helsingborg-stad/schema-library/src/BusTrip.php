...
use \Municipio\Schema\Contracts\BusTripContract;
...
class BusTrip extends BaseType implements BusTripContract, IntangibleContract, ThingContract, TripContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\BusStationContract|\Municipio\Schema\Contracts\BusStationContract[]|\Municipio\Schema\Contracts\BusStopContract|\Municipio\Schema\Contracts\BusStopContract[] $arrivalBusStop
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BusStationContract|\Municipio\Schema\Contracts\BusStationContract[]|\Municipio\Schema\Contracts\BusStopContract|\Municipio\Schema\Contracts\BusStopContract[] $departureBusStop
     *
     * @return static
     *
