 ...
 *
 */
class AutomotiveBusiness extends BaseType implements AutomotiveBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
