...
use \Municipio\Schema\Contracts\ProductCollectionContract;
use \Municipio\Schema\Contracts\CollectionContract;
...
class ProductCollection extends BaseType implements ProductCollectionContract, CollectionContract, CreativeWorkContract, ProductContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\TypeAndQuantityNodeContract|\Municipio\Schema\Contracts\TypeAndQuantityNodeContract[] $includesObject
     *
     * @return static
     *
