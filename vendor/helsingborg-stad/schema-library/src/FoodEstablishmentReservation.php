...
use \Municipio\Schema\Contracts\FoodEstablishmentReservationContract;
...
class FoodEstablishmentReservation extends BaseType implements FoodEstablishmentReservationContract, IntangibleContract, ReservationContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|int|int[] $partySize
     *
     * @return static
     *
