...
use \Municipio\Schema\Contracts\PreschoolContract;
 ...
 *
 */
class Preschool extends BaseType implements PreschoolContract, CivicStructureContract, EducationalOrganizationContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
