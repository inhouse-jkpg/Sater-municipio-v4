...
use \Municipio\Schema\Contracts\PropertyValueSpecificationContract;
...
class PropertyValueSpecification extends BaseType implements PropertyValueSpecificationContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[]|string|string[] $defaultValue
     *
     * @return static
     *
