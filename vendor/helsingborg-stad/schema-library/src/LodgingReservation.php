...
use \Municipio\Schema\Contracts\LodgingReservationContract;
...
class LodgingReservation extends BaseType implements LodgingReservationContract, IntangibleContract, ReservationContract, ThingContract
{
     ...
     * bed, etc.).
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|string|string[] $lodgingUnitType
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|int|int[] $numAdults
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|int|int[] $numChildren
     *
     * @return static
     *
