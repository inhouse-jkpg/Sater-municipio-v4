...
use \Municipio\Schema\Contracts\JewelryStoreContract;
 ...
 *
 */
class JewelryStore extends BaseType implements JewelryStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
