...
use \Municipio\Schema\Contracts\SeatContract;
...
class Seat extends BaseType implements SeatContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|string|string[] $seatingType
     *
     * @return static
     *
