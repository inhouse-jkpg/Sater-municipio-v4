...
use \Municipio\Schema\Contracts\BuddhistTempleContract;
use \Municipio\Schema\Contracts\CivicStructureContract;
use \Municipio\Schema\Contracts\PlaceContract;
use \Municipio\Schema\Contracts\PlaceOfWorshipContract;
 ...
 *
 */
class BuddhistTemple extends BaseType implements BuddhistTempleContract, CivicStructureContract, PlaceContract, PlaceOfWorshipContract, ThingContract
{
    /**
