...
use \Municipio\Schema\Contracts\BoatReservationContract;
 ...
 *
 */
class BoatReservation extends BaseType implements BoatReservationContract, IntangibleContract, ReservationContract, ThingContract
{
    /**
