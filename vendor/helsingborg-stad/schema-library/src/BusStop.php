...
use \Municipio\Schema\Contracts\BusStopContract;
 ...
 *
 */
class BusStop extends BaseType implements BusStopContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
