...
use \Municipio\Schema\Contracts\BookStoreContract;
 ...
 *
 */
class BookStore extends BaseType implements BookStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
