...
use \Municipio\Schema\Contracts\BusinessAudienceContract;
...
class BusinessAudience extends BaseType implements BusinessAudienceContract, AudienceContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $yearlyRevenue
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $yearsInOperation
     *
     * @return static
     *
