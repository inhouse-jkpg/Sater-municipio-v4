...
use \Municipio\Schema\Contracts\DepartmentStoreContract;
 ...
 *
 */
class DepartmentStore extends BaseType implements DepartmentStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
