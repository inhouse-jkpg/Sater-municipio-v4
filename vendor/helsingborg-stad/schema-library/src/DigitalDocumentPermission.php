...
use \Municipio\Schema\Contracts\DigitalDocumentPermissionContract;
...
class DigitalDocumentPermission extends BaseType implements DigitalDocumentPermissionContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AudienceContract|\Municipio\Schema\Contracts\AudienceContract[]|\Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $grantee
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DigitalDocumentPermissionTypeContract|\Municipio\Schema\Contracts\DigitalDocumentPermissionTypeContract[] $permissionType
     *
     * @return static
     *
