...
use \Municipio\Schema\Contracts\PerformActionContract;
...
class PerformAction extends BaseType implements PerformActionContract, ActionContract, PlayActionContract, ThingContract
{
     ...
     * occurred.
     *
     * @param \Municipio\Schema\Contracts\EntertainmentBusinessContract|\Municipio\Schema\Contracts\EntertainmentBusinessContract[] $entertainmentBusiness
     *
     * @return static
     *
