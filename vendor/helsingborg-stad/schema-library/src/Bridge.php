...
use \Municipio\Schema\Contracts\BridgeContract;
 ...
 *
 */
class Bridge extends BaseType implements BridgeContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
