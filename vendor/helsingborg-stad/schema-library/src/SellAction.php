...
use \Municipio\Schema\Contracts\SellActionContract;
...
class SellAction extends BaseType implements SellActionContract, ActionContract, ThingContract, TradeActionContract
{
     ...
     * bought the object.
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $buyer
     *
     * @return static
     *
