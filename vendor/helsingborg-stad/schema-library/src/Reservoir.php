...
use \Municipio\Schema\Contracts\ReservoirContract;
 ...
 *
 */
class Reservoir extends BaseType implements ReservoirContract, BodyOfWaterContract, LandformContract, PlaceContract, ThingContract
{
    /**
