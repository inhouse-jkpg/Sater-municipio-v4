...
use \Municipio\Schema\Contracts\LiveBlogPostingContract;
use \Municipio\Schema\Contracts\ArticleContract;
use \Municipio\Schema\Contracts\BlogPostingContract;
...
class LiveBlogPosting extends BaseType implements LiveBlogPostingContract, ArticleContract, BlogPostingContract, CreativeWorkContract, SocialMediaPostingContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\BlogPostingContract|\Municipio\Schema\Contracts\BlogPostingContract[] $liveBlogUpdate
     *
     * @return static
     *
