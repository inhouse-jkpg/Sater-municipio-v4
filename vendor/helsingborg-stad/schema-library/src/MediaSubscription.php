...
use \Municipio\Schema\Contracts\MediaSubscriptionContract;
 ...
 *
 */
class MediaSubscription extends BaseType implements MediaSubscriptionContract, IntangibleContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $authenticator
     *
     * @return static
     *
