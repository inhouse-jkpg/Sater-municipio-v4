...
use \Municipio\Schema\Contracts\WholesaleStoreContract;
 ...
 *
 */
class WholesaleStore extends BaseType implements WholesaleStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
