...
use \Municipio\Schema\Contracts\SearchRescueOrganizationContract;
 ...
 *
 */
class SearchRescueOrganization extends BaseType implements SearchRescueOrganizationContract, OrganizationContract, ThingContract
{
    /**
