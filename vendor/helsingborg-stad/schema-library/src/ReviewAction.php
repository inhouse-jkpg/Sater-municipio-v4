...
use \Municipio\Schema\Contracts\ReviewActionContract;
...
class ReviewAction extends BaseType implements ReviewActionContract, ActionContract, AssessActionContract, ThingContract
{
     ...
     * the action.
     *
     * @param \Municipio\Schema\Contracts\ReviewContract|\Municipio\Schema\Contracts\ReviewContract[] $resultReview
     *
     * @return static
     *
