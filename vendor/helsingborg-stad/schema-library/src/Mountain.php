...
use \Municipio\Schema\Contracts\MountainContract;
 ...
 *
 */
class Mountain extends BaseType implements MountainContract, LandformContract, PlaceContract, ThingContract
{
    /**
