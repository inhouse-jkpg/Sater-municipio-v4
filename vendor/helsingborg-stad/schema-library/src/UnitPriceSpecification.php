...
use \Municipio\Schema\Contracts\UnitPriceSpecificationContract;
use \Municipio\Schema\Contracts\IntangibleContract;
use \Municipio\Schema\Contracts\PriceSpecificationContract;
...
class UnitPriceSpecification extends BaseType implements UnitPriceSpecificationContract, IntangibleContract, PriceSpecificationContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[]|\Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|float|float[]|int|int[] $billingDuration
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PriceComponentTypeEnumerationContract|\Municipio\Schema\Contracts\PriceComponentTypeEnumerationContract[] $priceComponentType
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PriceTypeEnumerationContract|\Municipio\Schema\Contracts\PriceTypeEnumerationContract[]|string|string[] $priceType
     *
     * @return static
     *
     ...
     * to a standard unit.
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $referenceQuantity
     *
     * @return static
     *
