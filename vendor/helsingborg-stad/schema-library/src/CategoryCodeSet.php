...
use \Municipio\Schema\Contracts\CategoryCodeSetContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\DefinedTermSetContract;
 ...
 *
 */
class CategoryCodeSet extends BaseType implements CategoryCodeSetContract, CreativeWorkContract, DefinedTermSetContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\CategoryCodeContract|\Municipio\Schema\Contracts\CategoryCodeContract[] $hasCategoryCode
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/894
     */
    public function hasCategoryCode($hasCategoryCode)
    {
        return $this->setProperty('hasCategoryCode', $hasCategoryCode);
    }
