...
use \Municipio\Schema\Contracts\GasStationContract;
 ...
 *
 */
class GasStation extends BaseType implements GasStationContract, AutomotiveBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
