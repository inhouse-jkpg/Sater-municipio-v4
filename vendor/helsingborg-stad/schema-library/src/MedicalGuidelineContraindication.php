...
use \Municipio\Schema\Contracts\MedicalGuidelineContraindicationContract;
use \Municipio\Schema\Contracts\MedicalEntityContract;
use \Municipio\Schema\Contracts\MedicalGuidelineContract;
 ...
 *
 */
class MedicalGuidelineContraindication extends BaseType implements MedicalGuidelineContraindicationContract, MedicalEntityContract, MedicalGuidelineContract, ThingContract
{
    /**
     ...
     * (enumerated).
     *
     * @param \Municipio\Schema\Contracts\MedicalEvidenceLevelContract|\Municipio\Schema\Contracts\MedicalEvidenceLevelContract[] $evidenceLevel
     *
     * @return static
     *
     ...
     * guideline.
     *
     * @param \Municipio\Schema\Contracts\MedicalEntityContract|\Municipio\Schema\Contracts\MedicalEntityContract[] $guidelineSubject
     *
     * @return static
     *
