...
use \Municipio\Schema\Contracts\MosqueContract;
 ...
 *
 */
class Mosque extends BaseType implements MosqueContract, CivicStructureContract, PlaceContract, PlaceOfWorshipContract, ThingContract
{
    /**
