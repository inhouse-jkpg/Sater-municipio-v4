...
use \Municipio\Schema\Contracts\MemberProgramTierContract;
...
class MemberProgramTier extends BaseType implements MemberProgramTierContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\TierBenefitEnumerationContract|\Municipio\Schema\Contracts\TierBenefitEnumerationContract[] $hasTierBenefit
     *
     * @return static
     *
     ...
     * be specified.
     *
     * @param \Municipio\Schema\Contracts\CreditCardContract|\Municipio\Schema\Contracts\CreditCardContract[]|\Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|\Municipio\Schema\Contracts\UnitPriceSpecificationContract|\Municipio\Schema\Contracts\UnitPriceSpecificationContract[]|string|string[] $hasTierRequirement
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MemberProgramContract|\Municipio\Schema\Contracts\MemberProgramContract[] $isTierOf
     *
     * @return static
     *
