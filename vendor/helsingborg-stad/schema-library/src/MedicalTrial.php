...
use \Municipio\Schema\Contracts\MedicalTrialContract;
...
class MedicalTrial extends BaseType implements MedicalTrialContract, MedicalEntityContract, MedicalStudyContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalTrialDesignContract|\Municipio\Schema\Contracts\MedicalTrialDesignContract[] $trialDesign
     *
     * @return static
     *
