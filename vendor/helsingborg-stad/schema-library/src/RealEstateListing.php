...
use \Municipio\Schema\Contracts\RealEstateListingContract;
 ...
 *
 */
class RealEstateListing extends BaseType implements RealEstateListingContract, CreativeWorkContract, ThingContract, WebPageContract
{
    /**
