...
use \Municipio\Schema\Contracts\PodcastSeasonContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\CreativeWorkSeasonContract;
 ...
 *
 */
class PodcastSeason extends BaseType implements PodcastSeasonContract, CreativeWorkContract, CreativeWorkSeasonContract, ThingContract
{
    /**
