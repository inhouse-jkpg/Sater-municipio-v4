...
use \Municipio\Schema\Contracts\DietContract;
...
class Diet extends BaseType implements DietContract, CreativeWorkContract, LifestyleModificationContract, MedicalEntityContract, ThingContract
{
    ...
    {
        return $this->setProperty('dietFeatures', $dietFeatures);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $endorsers
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('endorsers', $endorsers);
    }
    ...
    {
        return $this->setProperty('expertConsiderations', $expertConsiderations);
    }
    ...
    {
        return $this->setProperty('physiologicalBenefits', $physiologicalBenefits);
    }
    ...
    {
        return $this->setProperty('risks', $risks);
    }
