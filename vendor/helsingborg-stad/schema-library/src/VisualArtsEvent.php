...
use \Municipio\Schema\Contracts\VisualArtsEventContract;
 ...
 *
 */
class VisualArtsEvent extends BaseType implements VisualArtsEventContract, EventContract, ThingContract
{
    /**
