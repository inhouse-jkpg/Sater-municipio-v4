...
use \Municipio\Schema\Contracts\OutletStoreContract;
 ...
 *
 */
class OutletStore extends BaseType implements OutletStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
