...
use \Municipio\Schema\Contracts\SizeSpecificationContract;
...
class SizeSpecification extends BaseType implements SizeSpecificationContract, EnumerationContract, IntangibleContract, QualitativeValueContract, ThingContract
{
     ...
     * "regular".
     *
     * @param \Municipio\Schema\Contracts\SizeGroupEnumerationContract|\Municipio\Schema\Contracts\SizeGroupEnumerationContract[]|string|string[] $sizeGroup
     *
     * @return static
     *
     ...
     * "Imperial").
     *
     * @param \Municipio\Schema\Contracts\SizeSystemEnumerationContract|\Municipio\Schema\Contracts\SizeSystemEnumerationContract[]|string|string[] $sizeSystem
     *
     * @return static
     *
