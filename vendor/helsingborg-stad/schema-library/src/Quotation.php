...
use \Municipio\Schema\Contracts\QuotationContract;
 ...
 *
 */
class Quotation extends BaseType implements QuotationContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $spokenByCharacter
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/271
     */
    public function spokenByCharacter($spokenByCharacter)
    {
        return $this->setProperty('spokenByCharacter', $spokenByCharacter);
    }
