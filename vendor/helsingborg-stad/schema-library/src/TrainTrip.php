...
use \Municipio\Schema\Contracts\TrainTripContract;
...
class TrainTrip extends BaseType implements TrainTripContract, IntangibleContract, ThingContract, TripContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\TrainStationContract|\Municipio\Schema\Contracts\TrainStationContract[] $arrivalStation
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\TrainStationContract|\Municipio\Schema\Contracts\TrainStationContract[] $departureStation
     *
     * @return static
     *
