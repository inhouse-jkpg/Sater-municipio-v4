...
use \Municipio\Schema\Contracts\DepositAccountContract;
use \Municipio\Schema\Contracts\BankAccountContract;
use \Municipio\Schema\Contracts\FinancialProductContract;
use \Municipio\Schema\Contracts\IntangibleContract;
use \Municipio\Schema\Contracts\InvestmentOrDepositContract;
...
class DepositAccount extends BaseType implements DepositAccountContract, BankAccountContract, FinancialProductContract, IntangibleContract, InvestmentOrDepositContract, ServiceContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[] $accountMinimumInflow
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[] $accountOverdraftLimit
     *
     * @return static
     *
