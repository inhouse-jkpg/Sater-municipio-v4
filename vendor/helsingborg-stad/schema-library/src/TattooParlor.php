...
use \Municipio\Schema\Contracts\TattooParlorContract;
 ...
 *
 */
class TattooParlor extends BaseType implements TattooParlorContract, HealthAndBeautyBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
