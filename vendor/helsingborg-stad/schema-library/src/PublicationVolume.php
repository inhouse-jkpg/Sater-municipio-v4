...
use \Municipio\Schema\Contracts\PublicationVolumeContract;
 ...
 *
 */
class PublicationVolume extends BaseType implements PublicationVolumeContract, CreativeWorkContract, ThingContract
{
    /**
