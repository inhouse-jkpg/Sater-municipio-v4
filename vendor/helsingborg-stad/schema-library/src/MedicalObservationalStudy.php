...
use \Municipio\Schema\Contracts\MedicalObservationalStudyContract;
...
class MedicalObservationalStudy extends BaseType implements MedicalObservationalStudyContract, MedicalEntityContract, MedicalStudyContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalObservationalStudyDesignContract|\Municipio\Schema\Contracts\MedicalObservationalStudyDesignContract[] $studyDesign
     *
     * @return static
     *
