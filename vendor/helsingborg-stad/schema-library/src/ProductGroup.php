...
use \Municipio\Schema\Contracts\ProductGroupContract;
 ...
 *
 */
class ProductGroup extends BaseType implements ProductGroupContract, ProductContract, ThingContract
{
    /**
     ...
     * [[ProductModel]]).
     *
     * @param \Municipio\Schema\Contracts\ProductContract|\Municipio\Schema\Contracts\ProductContract[] $hasVariant
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('hasVariant', $hasVariant);
    }
    ...
    {
        return $this->setProperty('productGroupID', $productGroupID);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[]|string|string[] $variesBy
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('variesBy', $variesBy);
    }
