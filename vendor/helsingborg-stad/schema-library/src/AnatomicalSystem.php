...
use \Municipio\Schema\Contracts\AnatomicalSystemContract;
...
class AnatomicalSystem extends BaseType implements AnatomicalSystemContract, MedicalEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[]|\Municipio\Schema\Contracts\AnatomicalSystemContract|\Municipio\Schema\Contracts\AnatomicalSystemContract[] $comprisedOf
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('comprisedOf', $comprisedOf);
    }
     ...
     * organ system.
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[] $relatedStructure
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('relatedStructure', $relatedStructure);
    }
