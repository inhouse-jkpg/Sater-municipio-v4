...
use \Municipio\Schema\Contracts\DaySpaContract;
 ...
 *
 */
class DaySpa extends BaseType implements DaySpaContract, HealthAndBeautyBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
