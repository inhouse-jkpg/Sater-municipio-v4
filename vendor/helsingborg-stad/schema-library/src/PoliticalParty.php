...
use \Municipio\Schema\Contracts\PoliticalPartyContract;
 ...
 *
 */
class PoliticalParty extends BaseType implements PoliticalPartyContract, OrganizationContract, ThingContract
{
    /**
