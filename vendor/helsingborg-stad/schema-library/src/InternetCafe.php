...
use \Municipio\Schema\Contracts\InternetCafeContract;
 ...
 *
 */
class InternetCafe extends BaseType implements InternetCafeContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
