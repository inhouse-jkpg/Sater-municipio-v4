...
use \Municipio\Schema\Contracts\DrugContract;
...
class Drug extends BaseType implements DrugContract, MedicalEntityContract, ProductContract, SubstanceContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugStrengthContract|\Municipio\Schema\Contracts\DrugStrengthContract[] $availableStrength
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugClassContract|\Municipio\Schema\Contracts\DrugClassContract[] $drugClass
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\HealthInsurancePlanContract|\Municipio\Schema\Contracts\HealthInsurancePlanContract[] $includedInHealthInsurancePlan
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugContract|\Municipio\Schema\Contracts\DrugContract[] $interactingDrug
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugPregnancyCategoryContract|\Municipio\Schema\Contracts\DrugPregnancyCategoryContract[] $pregnancyCategory
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugPrescriptionStatusContract|\Municipio\Schema\Contracts\DrugPrescriptionStatusContract[]|string|string[] $prescriptionStatus
     *
     * @return static
     *
     ...
     * alternatives.
     *
     * @param \Municipio\Schema\Contracts\DrugContract|\Municipio\Schema\Contracts\DrugContract[] $relatedDrug
     *
     * @return static
     *
