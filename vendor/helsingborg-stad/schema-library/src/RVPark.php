...
use \Municipio\Schema\Contracts\RVParkContract;
 ...
 *
 */
class RVPark extends BaseType implements RVParkContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
