...
use \Municipio\Schema\Contracts\VideoGameClipContract;
use \Municipio\Schema\Contracts\ClipContract;
 ...
 *
 */
class VideoGameClip extends BaseType implements VideoGameClipContract, ClipContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\HyperTocEntryContract|\Municipio\Schema\Contracts\HyperTocEntryContract[]|float|float[]|int|int[] $endOffset
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('endOffset', $endOffset);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\EpisodeContract|\Municipio\Schema\Contracts\EpisodeContract[] $partOfEpisode
     *
     * @return static
     *
     ...
     * beginning of the work.
     *
     * @param \Municipio\Schema\Contracts\HyperTocEntryContract|\Municipio\Schema\Contracts\HyperTocEntryContract[]|float|float[]|int|int[] $startOffset
     *
     * @return static
     *
