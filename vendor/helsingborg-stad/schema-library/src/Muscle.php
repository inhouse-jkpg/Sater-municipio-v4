...
use \Municipio\Schema\Contracts\MuscleContract;
...
class Muscle extends BaseType implements MuscleContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MuscleContract|\Municipio\Schema\Contracts\MuscleContract[] $antagonist
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('antagonist', $antagonist);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\VesselContract|\Municipio\Schema\Contracts\VesselContract[] $bloodSupply
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('bloodSupply', $bloodSupply);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[] $insertion
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('insertion', $insertion);
    }
    ...
    {
        return $this->setProperty('muscleAction', $muscleAction);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\NerveContract|\Municipio\Schema\Contracts\NerveContract[] $nerve
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('nerve', $nerve);
    }
