...
use \Municipio\Schema\Contracts\VeinContract;
...
class Vein extends BaseType implements VeinContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract, VesselContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\VesselContract|\Municipio\Schema\Contracts\VesselContract[] $drainsTo
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('drainsTo', $drainsTo);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[]|\Municipio\Schema\Contracts\AnatomicalSystemContract|\Municipio\Schema\Contracts\AnatomicalSystemContract[] $regionDrained
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[] $tributary
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('tributary', $tributary);
    }
