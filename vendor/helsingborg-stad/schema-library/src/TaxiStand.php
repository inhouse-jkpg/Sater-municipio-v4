...
use \Municipio\Schema\Contracts\TaxiStandContract;
 ...
 *
 */
class TaxiStand extends BaseType implements TaxiStandContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
