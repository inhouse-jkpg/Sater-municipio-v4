...
use \Municipio\Schema\Contracts\CommentActionContract;
 ...
 *
 */
class CommentAction extends BaseType implements CommentActionContract, ActionContract, CommunicateActionContract, InteractActionContract, ThingContract
{
    /**
     ...
     * action.
     *
     * @param \Municipio\Schema\Contracts\CommentContract|\Municipio\Schema\Contracts\CommentContract[] $resultComment
     *
     * @return static
     *
