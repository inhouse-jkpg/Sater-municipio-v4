...
use \Municipio\Schema\Contracts\CityHallContract;
 ...
 *
 */
class CityHall extends BaseType implements CityHallContract, CivicStructureContract, GovernmentBuildingContract, PlaceContract, ThingContract
{
    /**
