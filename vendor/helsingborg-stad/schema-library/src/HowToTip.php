...
use \Municipio\Schema\Contracts\HowToTipContract;
 ...
 *
 */
class HowToTip extends BaseType implements HowToTipContract, CreativeWorkContract, IntangibleContract, ListItemContract, ThingContract
{
    /**
