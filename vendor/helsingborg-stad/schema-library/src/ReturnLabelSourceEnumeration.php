...
use \Municipio\Schema\Contracts\ReturnLabelSourceEnumerationContract;
 ...
 */
class ReturnLabelSourceEnumeration extends BaseType implements ReturnLabelSourceEnumerationContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
