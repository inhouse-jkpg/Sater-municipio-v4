...
use \Municipio\Schema\Contracts\HospitalContract;
use \Municipio\Schema\Contracts\CivicStructureContract;
use \Municipio\Schema\Contracts\EmergencyServiceContract;
...
class Hospital extends BaseType implements HospitalContract, CivicStructureContract, EmergencyServiceContract, LocalBusinessContract, MedicalOrganizationContract, OrganizationContract, PlaceContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\CDCPMDRecordContract|\Municipio\Schema\Contracts\CDCPMDRecordContract[]|\Municipio\Schema\Contracts\DatasetContract|\Municipio\Schema\Contracts\DatasetContract[] $healthcareReportingData
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('healthcareReportingData', $healthcareReportingData);
    }
