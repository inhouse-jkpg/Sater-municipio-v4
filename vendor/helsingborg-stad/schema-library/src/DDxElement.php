...
use \Municipio\Schema\Contracts\DDxElementContract;
...
class DDxElement extends BaseType implements DDxElementContract, MedicalEntityContract, MedicalIntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalSignOrSymptomContract|\Municipio\Schema\Contracts\MedicalSignOrSymptomContract[] $distinguishingSign
     *
     * @return static
     *
