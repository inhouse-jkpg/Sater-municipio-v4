...
use \Municipio\Schema\Contracts\LiquorStoreContract;
 ...
 *
 */
class LiquorStore extends BaseType implements LiquorStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
