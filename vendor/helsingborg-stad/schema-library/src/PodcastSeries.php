...
use \Municipio\Schema\Contracts\PodcastSeriesContract;
 ...
 *
 */
class PodcastSeries extends BaseType implements PodcastSeriesContract, CreativeWorkContract, CreativeWorkSeriesContract, IntangibleContract, SeriesContract, ThingContract
{
    /**
