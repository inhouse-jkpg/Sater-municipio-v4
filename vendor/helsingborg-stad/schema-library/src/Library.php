...
use \Municipio\Schema\Contracts\LibraryContract;
 ...
 *
 */
class Library extends BaseType implements LibraryContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
