...
use \Municipio\Schema\Contracts\MedicalCauseContract;
...
class MedicalCause extends BaseType implements MedicalCauseContract, MedicalEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalEntityContract|\Municipio\Schema\Contracts\MedicalEntityContract[] $causeOf
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('causeOf', $causeOf);
    }
