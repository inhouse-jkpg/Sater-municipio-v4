...
use \Municipio\Schema\Contracts\PlanActionContract;
 ...
 *
 */
class PlanAction extends BaseType implements PlanActionContract, ActionContract, OrganizeActionContract, ThingContract
{
    /**
