...
use \Municipio\Schema\Contracts\SportsEventContract;
...
class SportsEvent extends BaseType implements SportsEventContract, EventContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[]|\Municipio\Schema\Contracts\SportsTeamContract|\Municipio\Schema\Contracts\SportsTeamContract[] $awayTeam
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[]|\Municipio\Schema\Contracts\SportsTeamContract|\Municipio\Schema\Contracts\SportsTeamContract[] $competitor
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[]|\Municipio\Schema\Contracts\SportsTeamContract|\Municipio\Schema\Contracts\SportsTeamContract[] $homeTeam
     *
     * @return static
     *
