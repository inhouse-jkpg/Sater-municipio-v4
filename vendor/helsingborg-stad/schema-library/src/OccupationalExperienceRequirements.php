...
use \Municipio\Schema\Contracts\OccupationalExperienceRequirementsContract;
 ...
 *
 */
class OccupationalExperienceRequirements extends BaseType implements OccupationalExperienceRequirementsContract, IntangibleContract, ThingContract
{
    /**
    ...
    {
        return $this->setProperty('monthsOfExperience', $monthsOfExperience);
    }
