...
use \Municipio\Schema\Contracts\SportsTeamContract;
use \Municipio\Schema\Contracts\OrganizationContract;
use \Municipio\Schema\Contracts\SportsOrganizationContract;
 ...
 *
 */
class SportsTeam extends BaseType implements SportsTeamContract, OrganizationContract, SportsOrganizationContract, ThingContract
{
    /**
     ...
     * opposed to a coach.
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $athlete
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $coach
     *
     * @return static
     *
