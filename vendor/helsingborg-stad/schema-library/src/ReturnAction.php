...
use \Municipio\Schema\Contracts\ReturnActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\ThingContract;
use \Municipio\Schema\Contracts\TransferActionContract;
 ...
 *
 */
class ReturnAction extends BaseType implements ReturnActionContract, ActionContract, ThingContract, TransferActionContract
{
    /**
