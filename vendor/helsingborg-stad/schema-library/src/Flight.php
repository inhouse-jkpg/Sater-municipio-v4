...
class Flight extends BaseType implements FlightContract, IntangibleContract, ThingContract, TripContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\VehicleContract|\Municipio\Schema\Contracts\VehicleContract[]|string|string[] $aircraft
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\AirportContract|\Municipio\Schema\Contracts\AirportContract[] $arrivalAirport
     *
     * @return static
     *
     ...
     * group-based).
     *
     * @param \Municipio\Schema\Contracts\BoardingPolicyTypeContract|\Municipio\Schema\Contracts\BoardingPolicyTypeContract[] $boardingPolicy
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\AirportContract|\Municipio\Schema\Contracts\AirportContract[] $departureAirport
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[]|string|string[] $estimatedFlightDuration
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DistanceContract|\Municipio\Schema\Contracts\DistanceContract[]|string|string[] $flightDistance
     *
     * @return static
     *
     ...
     * (see examples).
     *
     * @param \Municipio\Schema\Contracts\ItemListContract|\Municipio\Schema\Contracts\ItemListContract[]|\Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $itinerary
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\TripContract|\Municipio\Schema\Contracts\TripContract[] $partOfTrip
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\TripContract|\Municipio\Schema\Contracts\TripContract[] $subTrip
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $tripOrigin
     *
     * @return static
     *
