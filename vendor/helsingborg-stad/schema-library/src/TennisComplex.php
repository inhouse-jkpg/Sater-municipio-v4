...
use \Municipio\Schema\Contracts\TennisComplexContract;
 ...
 *
 */
class TennisComplex extends BaseType implements TennisComplexContract, LocalBusinessContract, OrganizationContract, PlaceContract, SportsActivityLocationContract, ThingContract
{
    /**
