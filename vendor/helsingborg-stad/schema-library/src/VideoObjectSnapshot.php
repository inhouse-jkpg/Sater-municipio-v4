...
use \Municipio\Schema\Contracts\VideoObjectSnapshotContract;
...
use \Municipio\Schema\Contracts\VideoObjectContract;
 ...
 *
 */
class VideoObjectSnapshot extends BaseType implements VideoObjectSnapshotContract, CreativeWorkContract, MediaObjectContract, ThingContract, VideoObjectContract
{
    /**
     ...
     * [[encodingFormat]].
     *
     * @param \Municipio\Schema\Contracts\MediaObjectContract|\Municipio\Schema\Contracts\MediaObjectContract[]|string|string[] $caption
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('embeddedTextCaption', $embeddedTextCaption);
    }
