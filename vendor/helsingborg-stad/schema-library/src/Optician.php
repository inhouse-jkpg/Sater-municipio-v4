...
use \Municipio\Schema\Contracts\OpticianContract;
 ...
 *
 */
class Optician extends BaseType implements OpticianContract, LocalBusinessContract, MedicalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
