...
use \Municipio\Schema\Contracts\ClothingStoreContract;
 ...
 *
 */
class ClothingStore extends BaseType implements ClothingStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
