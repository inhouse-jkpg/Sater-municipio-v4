...
use \Municipio\Schema\Contracts\TouristInformationCenterContract;
 ...
 *
 */
class TouristInformationCenter extends BaseType implements TouristInformationCenterContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
