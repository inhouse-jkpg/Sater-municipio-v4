...
use \Municipio\Schema\Contracts\MemberProgramContract;
 ...
 *
 */
class MemberProgram extends BaseType implements MemberProgramContract, IntangibleContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\MemberProgramTierContract|\Municipio\Schema\Contracts\MemberProgramTierContract[] $hasTiers
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/3563
     */
    public function hasTiers($hasTiers)
    {
        return $this->setProperty('hasTiers', $hasTiers);
    }
