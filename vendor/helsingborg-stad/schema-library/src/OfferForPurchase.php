...
use \Municipio\Schema\Contracts\OfferForPurchaseContract;
...
class OfferForPurchase extends BaseType implements OfferForPurchaseContract, IntangibleContract, OfferContract, ThingContract
{
     ...
     * a surcharge).
     *
     * @param \Municipio\Schema\Contracts\OfferContract|\Municipio\Schema\Contracts\OfferContract[] $addOn
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $advanceBookingRequirement
     *
     * @return static
     *
     ...
     * Pre-order, etc.
     *
     * @param \Municipio\Schema\Contracts\ItemAvailabilityContract|\Municipio\Schema\Contracts\ItemAvailabilityContract[] $availability
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $availableAtOrFrom
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DeliveryMethodContract|\Municipio\Schema\Contracts\DeliveryMethodContract[] $availableDeliveryMethod
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BusinessFunctionContract|\Municipio\Schema\Contracts\BusinessFunctionContract[] $businessFunction
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $deliveryLeadTime
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BusinessEntityTypeContract|\Municipio\Schema\Contracts\BusinessEntityTypeContract[] $eligibleCustomerType
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $eligibleDuration
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $eligibleQuantity
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PriceSpecificationContract|\Municipio\Schema\Contracts\PriceSpecificationContract[] $eligibleTransactionVolume
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $inventoryLevel
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\AggregateOfferContract|\Municipio\Schema\Contracts\AggregateOfferContract[]|\Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|\Municipio\Schema\Contracts\EventContract|\Municipio\Schema\Contracts\EventContract[]|\Municipio\Schema\Contracts\MenuItemContract|\Municipio\Schema\Contracts\MenuItemContract[]|\Municipio\Schema\Contracts\ProductContract|\Municipio\Schema\Contracts\ProductContract[]|\Municipio\Schema\Contracts\ServiceContract|\Municipio\Schema\Contracts\ServiceContract[]|\Municipio\Schema\Contracts\TripContract|\Municipio\Schema\Contracts\TripContract[] $itemOffered
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $offeredBy
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $seller
     *
     * @return static
     *
     ...
     * with an [[Offer]].
     *
     * @param \Municipio\Schema\Contracts\OfferShippingDetailsContract|\Municipio\Schema\Contracts\OfferShippingDetailsContract[] $shippingDetails
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\WarrantyPromiseContract|\Municipio\Schema\Contracts\WarrantyPromiseContract[] $warranty
     *
     * @return static
     *
