...
use \Municipio\Schema\Contracts\CourthouseContract;
use \Municipio\Schema\Contracts\CivicStructureContract;
use \Municipio\Schema\Contracts\GovernmentBuildingContract;
 ...
 *
 */
class Courthouse extends BaseType implements CourthouseContract, CivicStructureContract, GovernmentBuildingContract, PlaceContract, ThingContract
{
    /**
