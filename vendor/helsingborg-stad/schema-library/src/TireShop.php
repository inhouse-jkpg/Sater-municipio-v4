...
use \Municipio\Schema\Contracts\TireShopContract;
 ...
 *
 */
class TireShop extends BaseType implements TireShopContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
