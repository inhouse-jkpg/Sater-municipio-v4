...
use \Municipio\Schema\Contracts\JointContract;
...
class Joint extends BaseType implements JointContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract
{
    ...
    {
        return $this->setProperty('biomechnicalClass', $biomechnicalClass);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalEntityContract|\Municipio\Schema\Contracts\MedicalEntityContract[]|string|string[] $functionalClass
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('structuralClass', $structuralClass);
    }
