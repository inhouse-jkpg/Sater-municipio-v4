...
use \Municipio\Schema\Contracts\ServiceChannelContract;
...
class ServiceChannel extends BaseType implements ServiceChannelContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[] $processingTime
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ServiceContract|\Municipio\Schema\Contracts\ServiceContract[] $providesService
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $serviceLocation
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[] $servicePhone
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PostalAddressContract|\Municipio\Schema\Contracts\PostalAddressContract[] $servicePostalAddress
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[] $serviceSmsNumber
     *
     * @return static
     *
