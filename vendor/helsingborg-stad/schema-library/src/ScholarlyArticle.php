...
use \Municipio\Schema\Contracts\ScholarlyArticleContract;
 ...
 *
 */
class ScholarlyArticle extends BaseType implements ScholarlyArticleContract, ArticleContract, CreativeWorkContract, ThingContract
{
    /**
