...
use \Municipio\Schema\Contracts\HealthPlanFormularyContract;
 ...
 *
 */
class HealthPlanFormulary extends BaseType implements HealthPlanFormularyContract, IntangibleContract, ThingContract
{
    /**
