...
use \Municipio\Schema\Contracts\DurationContract;
use \Municipio\Schema\Contracts\IntangibleContract;
use \Municipio\Schema\Contracts\QuantityContract;
 ...
 *
 */
class Duration extends BaseType implements DurationContract, IntangibleContract, QuantityContract, ThingContract
{
    /**
