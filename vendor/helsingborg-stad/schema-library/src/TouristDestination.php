...
use \Municipio\Schema\Contracts\TouristDestinationContract;
...
class TouristDestination extends BaseType implements TouristDestinationContract, PlaceContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\TouristAttractionContract|\Municipio\Schema\Contracts\TouristAttractionContract[] $includesAttraction
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('includesAttraction', $includesAttraction);
    }
