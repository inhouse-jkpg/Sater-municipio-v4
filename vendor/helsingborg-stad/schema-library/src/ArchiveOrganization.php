...
use \Municipio\Schema\Contracts\ArchiveOrganizationContract;
 ...
 *
 */
class ArchiveOrganization extends BaseType implements ArchiveOrganizationContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\ArchiveComponentContract|\Municipio\Schema\Contracts\ArchiveComponentContract[] $archiveHeld
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('archiveHeld', $archiveHeld);
    }
