...
use \Municipio\Schema\Contracts\DiscussionForumPostingContract;
use \Municipio\Schema\Contracts\ArticleContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\SocialMediaPostingContract;
 ...
 *
 */
class DiscussionForumPosting extends BaseType implements DiscussionForumPostingContract, ArticleContract, CreativeWorkContract, SocialMediaPostingContract, ThingContract
{
    /**
