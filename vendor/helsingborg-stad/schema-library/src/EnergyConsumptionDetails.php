...
use \Municipio\Schema\Contracts\EnergyConsumptionDetailsContract;
...
class EnergyConsumptionDetails extends BaseType implements EnergyConsumptionDetailsContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\EUEnergyEfficiencyEnumerationContract|\Municipio\Schema\Contracts\EUEnergyEfficiencyEnumerationContract[] $energyEfficiencyScaleMax
     *
     * @return static
     *
     ...
     * January 1, 2020 is scaled from D to A+++.
     *
     * @param \Municipio\Schema\Contracts\EUEnergyEfficiencyEnumerationContract|\Municipio\Schema\Contracts\EUEnergyEfficiencyEnumerationContract[] $energyEfficiencyScaleMin
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\EnergyEfficiencyEnumerationContract|\Municipio\Schema\Contracts\EnergyEfficiencyEnumerationContract[] $hasEnergyEfficiencyCategory
     *
     * @return static
     *
