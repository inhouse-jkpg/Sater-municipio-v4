...
use \Municipio\Schema\Contracts\BroadcastFrequencySpecificationContract;
...
class BroadcastFrequencySpecification extends BaseType implements BroadcastFrequencySpecificationContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|float|float[]|int|int[] $broadcastFrequencyValue
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|string|string[] $broadcastSignalModulation
     *
     * @return static
     *
