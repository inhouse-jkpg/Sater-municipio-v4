...
use \Municipio\Schema\Contracts\MortgageLoanContract;
...
class MortgageLoan extends BaseType implements MortgageLoanContract, FinancialProductContract, IntangibleContract, LoanOrCreditContract, ServiceContract, ThingContract
{
    ...
    {
        return $this->setProperty('domiciledMortgage', $domiciledMortgage);
    }
     ...
     * at a later stage.
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[] $loanMortgageMandateAmount
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('loanMortgageMandateAmount', $loanMortgageMandateAmount);
    }
