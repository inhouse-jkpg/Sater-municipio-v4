...
use \Municipio\Schema\Contracts\MeasurementMethodEnumContract;
 ...
 */
class MeasurementMethodEnum extends BaseType implements MeasurementMethodEnumContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
