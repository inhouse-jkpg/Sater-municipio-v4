...
use \Municipio\Schema\Contracts\QuoteActionContract;
 ...
 *
 */
class QuoteAction extends BaseType implements QuoteActionContract, ActionContract, ThingContract, TradeActionContract
{
    /**
