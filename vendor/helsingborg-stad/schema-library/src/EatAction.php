...
use \Municipio\Schema\Contracts\EatActionContract;
 ...
 *
 */
class EatAction extends BaseType implements EatActionContract, ActionContract, ConsumeActionContract, ThingContract
{
    /**
