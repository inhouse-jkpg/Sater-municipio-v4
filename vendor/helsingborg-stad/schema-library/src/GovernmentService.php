...
use \Municipio\Schema\Contracts\GovernmentServiceContract;
...
class GovernmentService extends BaseType implements GovernmentServiceContract, IntangibleContract, ServiceContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $serviceOperator
     *
     * @return static
     *
