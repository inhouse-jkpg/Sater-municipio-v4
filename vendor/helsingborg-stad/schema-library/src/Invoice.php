...
use \Municipio\Schema\Contracts\InvoiceContract;
...
class Invoice extends BaseType implements InvoiceContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[] $billingPeriod
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|\Municipio\Schema\Contracts\PriceSpecificationContract|\Municipio\Schema\Contracts\PriceSpecificationContract[] $minimumPaymentDue
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PaymentStatusTypeContract|\Municipio\Schema\Contracts\PaymentStatusTypeContract[]|string|string[] $paymentStatus
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrderContract|\Municipio\Schema\Contracts\OrderContract[] $referencesOrder
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|\Municipio\Schema\Contracts\PriceSpecificationContract|\Municipio\Schema\Contracts\PriceSpecificationContract[] $totalPaymentDue
     *
     * @return static
     *
