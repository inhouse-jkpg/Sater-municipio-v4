...
use \Municipio\Schema\Contracts\MediaReviewContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\ReviewContract;
 ...
 *
 */
class MediaReview extends BaseType implements MediaReviewContract, CreativeWorkContract, ReviewContract, ThingContract
{
    /**
     ...
     * [[MediaReview]].
     *
     * @param \Municipio\Schema\Contracts\ReviewContract|\Municipio\Schema\Contracts\ReviewContract[] $associatedClaimReview
     *
     * @return static
     *
     ...
     * [[MediaReview]].
     *
     * @param \Municipio\Schema\Contracts\ReviewContract|\Municipio\Schema\Contracts\ReviewContract[] $associatedMediaReview
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ReviewContract|\Municipio\Schema\Contracts\ReviewContract[] $associatedReview
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $itemReviewed
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MediaManipulationRatingEnumerationContract|\Municipio\Schema\Contracts\MediaManipulationRatingEnumerationContract[] $mediaAuthenticityCategory
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/2450
     */
    public function mediaAuthenticityCategory($mediaAuthenticityCategory)
    {
        return $this->setProperty('mediaAuthenticityCategory', $mediaAuthenticityCategory);
    }
    ...
    {
        return $this->setProperty('originalMediaContextDescription', $originalMediaContextDescription);
    }
     ...
     * video file.
     *
     * @param \Municipio\Schema\Contracts\MediaObjectContract|\Municipio\Schema\Contracts\MediaObjectContract[]|\Municipio\Schema\Contracts\WebPageContract|\Municipio\Schema\Contracts\WebPageContract[]|string|string[] $originalMediaLink
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('originalMediaLink', $originalMediaLink);
    }
     ...
     * work.
     *
     * @param \Municipio\Schema\Contracts\RatingContract|\Municipio\Schema\Contracts\RatingContract[] $reviewRating
     *
     * @return static
     *
