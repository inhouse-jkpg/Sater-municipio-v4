...
use \Municipio\Schema\Contracts\ThreeDimensionalModelContract;
 ...
 *
 */
class ThreeDimensionalModel extends BaseType implements ThreeDimensionalModelContract, CreativeWorkContract, MediaObjectContract, ThingContract
{
    ...
    {
        return $this->setProperty('isResizable', $isResizable);
    }
