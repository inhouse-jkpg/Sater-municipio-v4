...
use \Municipio\Schema\Contracts\RestaurantContract;
 ...
 *
 */
class Restaurant extends BaseType implements RestaurantContract, FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
