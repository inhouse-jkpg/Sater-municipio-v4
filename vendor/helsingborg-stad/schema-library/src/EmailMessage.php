...
use \Municipio\Schema\Contracts\EmailMessageContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\MessageContract;
...
class EmailMessage extends BaseType implements EmailMessageContract, CreativeWorkContract, MessageContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $bccRecipient
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $ccRecipient
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $messageAttachment
     *
     * @return static
     *
     ...
     * end of the action.
     *
     * @param \Municipio\Schema\Contracts\AudienceContract|\Municipio\Schema\Contracts\AudienceContract[]|\Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $recipient
     *
     * @return static
     *
     ...
     * of the action.
     *
     * @param \Municipio\Schema\Contracts\AudienceContract|\Municipio\Schema\Contracts\AudienceContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $sender
     *
     * @return static
     *
     ...
     * message.
     *
     * @param \Municipio\Schema\Contracts\AudienceContract|\Municipio\Schema\Contracts\AudienceContract[]|\Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $toRecipient
     *
     * @return static
     *
