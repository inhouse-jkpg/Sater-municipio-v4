...
use \Municipio\Schema\Contracts\BusinessFunctionContract;
 ...
 */
class BusinessFunction extends BaseType implements BusinessFunctionContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
