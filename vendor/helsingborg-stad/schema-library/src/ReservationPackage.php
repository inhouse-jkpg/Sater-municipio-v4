...
use \Municipio\Schema\Contracts\ReservationPackageContract;
...
class ReservationPackage extends BaseType implements ReservationPackageContract, IntangibleContract, ReservationContract, ThingContract
{
     ...
     * property.
     *
     * @param \Municipio\Schema\Contracts\ReservationContract|\Municipio\Schema\Contracts\ReservationContract[] $subReservation
     *
     * @return static
     *
