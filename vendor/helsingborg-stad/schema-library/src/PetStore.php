...
use \Municipio\Schema\Contracts\PetStoreContract;
 ...
 *
 */
class PetStore extends BaseType implements PetStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
