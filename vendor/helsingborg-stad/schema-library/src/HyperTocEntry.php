...
use \Municipio\Schema\Contracts\HyperTocEntryContract;
 ...
 *
 */
class HyperTocEntry extends BaseType implements HyperTocEntryContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     * render.
     *
     * @param \Municipio\Schema\Contracts\HyperTocEntryContract|\Municipio\Schema\Contracts\HyperTocEntryContract[] $tocContinuation
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/2766
     */
    public function tocContinuation($tocContinuation)
    {
        return $this->setProperty('tocContinuation', $tocContinuation);
    }
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/2766
     */
    public function utterances($utterances)
    {
        return $this->setProperty('utterances', $utterances);
    }
