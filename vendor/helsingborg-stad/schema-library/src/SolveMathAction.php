...
use \Municipio\Schema\Contracts\SolveMathActionContract;
 ...
 *
 */
class SolveMathAction extends BaseType implements SolveMathActionContract, ActionContract, ThingContract
{
    /**
