...
use \Municipio\Schema\Contracts\NerveContract;
...
class Nerve extends BaseType implements NerveContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract
{
     ...
     * with [[branchOf]].
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[] $branch
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('branch', $branch);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\MuscleContract|\Municipio\Schema\Contracts\MuscleContract[] $nerveMotor
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('nerveMotor', $nerveMotor);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[]|\Municipio\Schema\Contracts\SuperficialAnatomyContract|\Municipio\Schema\Contracts\SuperficialAnatomyContract[] $sensoryUnit
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('sensoryUnit', $sensoryUnit);
    }

    /**
     * The neurological pathway that originates the neurons.
     *
     * @param \Municipio\Schema\Contracts\BrainStructureContract|\Municipio\Schema\Contracts\BrainStructureContract[] $sourcedFrom
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('sourcedFrom', $sourcedFrom);
    }
