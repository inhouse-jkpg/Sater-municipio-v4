...
use \Municipio\Schema\Contracts\MedicalRiskCalculatorContract;
use \Municipio\Schema\Contracts\MedicalEntityContract;
use \Municipio\Schema\Contracts\MedicalRiskEstimatorContract;
...
class MedicalRiskCalculator extends BaseType implements MedicalRiskCalculatorContract, MedicalEntityContract, MedicalRiskEstimatorContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalEntityContract|\Municipio\Schema\Contracts\MedicalEntityContract[] $estimatesRiskOf
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalRiskFactorContract|\Municipio\Schema\Contracts\MedicalRiskFactorContract[] $includedRiskFactor
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('includedRiskFactor', $includedRiskFactor);
    }
