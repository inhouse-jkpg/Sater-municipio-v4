...
use \Municipio\Schema\Contracts\PublicToiletContract;
 ...
 *
 */
class PublicToilet extends BaseType implements PublicToiletContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
