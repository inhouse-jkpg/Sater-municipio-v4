...
use \Municipio\Schema\Contracts\GroceryStoreContract;
 ...
 *
 */
class GroceryStore extends BaseType implements GroceryStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
