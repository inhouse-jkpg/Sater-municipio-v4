...
use \Municipio\Schema\Contracts\OrderActionContract;
 ...
 *
 */
class OrderAction extends BaseType implements OrderActionContract, ActionContract, ThingContract, TradeActionContract
{
    /**
