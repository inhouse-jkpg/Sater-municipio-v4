...
use \Municipio\Schema\Contracts\ResearchOrganizationContract;
 ...
 *
 */
class ResearchOrganization extends BaseType implements ResearchOrganizationContract, OrganizationContract, ThingContract
{
    /**
