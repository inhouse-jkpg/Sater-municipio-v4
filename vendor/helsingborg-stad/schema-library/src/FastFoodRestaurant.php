...
use \Municipio\Schema\Contracts\FastFoodRestaurantContract;
use \Municipio\Schema\Contracts\FoodEstablishmentContract;
 ...
 *
 */
class FastFoodRestaurant extends BaseType implements FastFoodRestaurantContract, FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
     ...
     * of the menu.
     *
     * @param \Municipio\Schema\Contracts\MenuContract|\Municipio\Schema\Contracts\MenuContract[]|string|string[] $hasMenu
     *
     * @return static
     *
     ...
     * of the menu.
     *
     * @param \Municipio\Schema\Contracts\MenuContract|\Municipio\Schema\Contracts\MenuContract[]|string|string[] $menu
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\RatingContract|\Municipio\Schema\Contracts\RatingContract[] $starRating
     *
     * @return static
     *
