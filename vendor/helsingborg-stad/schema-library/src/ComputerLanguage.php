...
use \Municipio\Schema\Contracts\ComputerLanguageContract;
 ...
 *
 */
class ComputerLanguage extends BaseType implements ComputerLanguageContract, IntangibleContract, ThingContract
{
    /**
