...
use \Municipio\Schema\Contracts\EventReservationContract;
 ...
 *
 */
class EventReservation extends BaseType implements EventReservationContract, IntangibleContract, ReservationContract, ThingContract
{
    /**
