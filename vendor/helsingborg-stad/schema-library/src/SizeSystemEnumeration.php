...
use \Municipio\Schema\Contracts\SizeSystemEnumerationContract;
 ...
 */
class SizeSystemEnumeration extends BaseType implements SizeSystemEnumerationContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
