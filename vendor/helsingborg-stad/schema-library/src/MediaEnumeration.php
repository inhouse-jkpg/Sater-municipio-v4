...
use \Municipio\Schema\Contracts\MediaEnumerationContract;
 ...
 */
class MediaEnumeration extends BaseType implements MediaEnumerationContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
