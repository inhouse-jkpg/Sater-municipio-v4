...
use \Municipio\Schema\Contracts\ExercisePlanContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\LifestyleModificationContract;
use \Municipio\Schema\Contracts\MedicalEntityContract;
use \Municipio\Schema\Contracts\PhysicalActivityContract;
...
class ExercisePlan extends BaseType implements ExercisePlanContract, CreativeWorkContract, LifestyleModificationContract, MedicalEntityContract, PhysicalActivityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[]|\Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $activityDuration
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('activityDuration', $activityDuration);
    }

    /**
     * How often one should engage in the activity.
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|string|string[] $activityFrequency
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('activityFrequency', $activityFrequency);
    }
     ...
     * over time, etc.
     *
     * @param string|string[] $additionalVariable
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('additionalVariable', $additionalVariable);
    }
     ...
     * the movement.
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|string|string[] $intensity
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('intensity', $intensity);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|float|float[]|int|int[] $repetitions
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('repetitions', $repetitions);
    }

    /**
     * How often one should break from the activity.
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|string|string[] $restPeriods
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('restPeriods', $restPeriods);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\EnergyContract|\Municipio\Schema\Contracts\EnergyContract[]|\Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $workload
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('workload', $workload);
    }
