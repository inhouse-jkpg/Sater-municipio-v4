...
use \Municipio\Schema\Contracts\EndorseActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\AssessActionContract;
use \Municipio\Schema\Contracts\ReactActionContract;
...
class EndorseAction extends BaseType implements EndorseActionContract, ActionContract, AssessActionContract, ReactActionContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $endorsee
     *
     * @return static
     *
