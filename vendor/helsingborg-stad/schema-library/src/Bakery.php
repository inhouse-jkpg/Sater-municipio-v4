...
use \Municipio\Schema\Contracts\BakeryContract;
 ...
 *
 */
class Bakery extends BaseType implements BakeryContract, FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
