...
use \Municipio\Schema\Contracts\PondContract;
 ...
 *
 */
class Pond extends BaseType implements PondContract, BodyOfWaterContract, LandformContract, PlaceContract, ThingContract
{
    /**
