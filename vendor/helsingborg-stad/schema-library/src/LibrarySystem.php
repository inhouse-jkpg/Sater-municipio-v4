...
use \Municipio\Schema\Contracts\LibrarySystemContract;
 ...
 *
 */
class LibrarySystem extends BaseType implements LibrarySystemContract, OrganizationContract, ThingContract
{
    /**
