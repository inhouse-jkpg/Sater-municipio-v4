...
use \Municipio\Schema\Contracts\MusicStoreContract;
 ...
 *
 */
class MusicStore extends BaseType implements MusicStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
