...
use \Municipio\Schema\Contracts\BuyActionContract;
...
class BuyAction extends BaseType implements BuyActionContract, ActionContract, ThingContract, TradeActionContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $vendor
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\WarrantyPromiseContract|\Municipio\Schema\Contracts\WarrantyPromiseContract[] $warrantyPromise
     *
     * @return static
     *
