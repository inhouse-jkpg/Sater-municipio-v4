...
use \Municipio\Schema\Contracts\ComicCoverArtContract;
use \Municipio\Schema\Contracts\ComicStoryContract;
use \Municipio\Schema\Contracts\CoverArtContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\ThingContract;
use \Municipio\Schema\Contracts\VisualArtworkContract;
...
class ComicCoverArt extends BaseType implements ComicCoverArtContract, ComicStoryContract, CoverArtContract, CreativeWorkContract, ThingContract, VisualArtworkContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $artist
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('artist', $artist);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $colorist
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('colorist', $colorist);
    }
     ...
     * are complete.
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $inker
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('inker', $inker);
    }
     ...
     * effects, to artwork.
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $letterer
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('letterer', $letterer);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $penciler
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('penciler', $penciler);
    }
