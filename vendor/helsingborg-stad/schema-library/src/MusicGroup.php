...
use \Municipio\Schema\Contracts\MusicGroupContract;
use \Municipio\Schema\Contracts\OrganizationContract;
use \Municipio\Schema\Contracts\PerformingGroupContract;
...
class MusicGroup extends BaseType implements MusicGroupContract, OrganizationContract, PerformingGroupContract, ThingContract
{
     ...
     * A music album.
     *
     * @param \Municipio\Schema\Contracts\MusicAlbumContract|\Municipio\Schema\Contracts\MusicAlbumContract[] $album
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicAlbumContract|\Municipio\Schema\Contracts\MusicAlbumContract[] $albums
     *
     * @return static
     *
     ...
     * Ringo.
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $musicGroupMember
     *
     * @return static
     *
