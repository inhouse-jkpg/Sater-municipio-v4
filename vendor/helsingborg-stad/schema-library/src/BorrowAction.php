...
use \Municipio\Schema\Contracts\BorrowActionContract;
...
class BorrowAction extends BaseType implements BorrowActionContract, ActionContract, ThingContract, TransferActionContract
{
     ...
     * borrowed.
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $lender
     *
     * @return static
     *
