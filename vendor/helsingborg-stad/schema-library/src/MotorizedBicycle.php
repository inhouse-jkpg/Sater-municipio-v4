...
use \Municipio\Schema\Contracts\MotorizedBicycleContract;
 ...
 *
 */
class MotorizedBicycle extends BaseType implements MotorizedBicycleContract, ProductContract, ThingContract, VehicleContract
{
    /**
