...
use \Municipio\Schema\Contracts\SendActionContract;
...
class SendAction extends BaseType implements SendActionContract, ActionContract, ThingContract, TransferActionContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DeliveryMethodContract|\Municipio\Schema\Contracts\DeliveryMethodContract[] $deliveryMethod
     *
     * @return static
     *
