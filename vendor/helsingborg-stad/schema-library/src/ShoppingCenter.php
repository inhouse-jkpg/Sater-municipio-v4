...
use \Municipio\Schema\Contracts\ShoppingCenterContract;
 ...
 *
 */
class ShoppingCenter extends BaseType implements ShoppingCenterContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
