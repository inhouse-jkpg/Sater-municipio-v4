...
use \Municipio\Schema\Contracts\CookActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\CreateActionContract;
...
class CookAction extends BaseType implements CookActionContract, ActionContract, CreateActionContract, ThingContract
{
     ...
     * action occurred.
     *
     * @param \Municipio\Schema\Contracts\FoodEstablishmentContract|\Municipio\Schema\Contracts\FoodEstablishmentContract[]|\Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $foodEstablishment
     *
     * @return static
     *
     ...
     * occurred.
     *
     * @param \Municipio\Schema\Contracts\FoodEventContract|\Municipio\Schema\Contracts\FoodEventContract[] $foodEvent
     *
     * @return static
     *
     ...
     * action.
     *
     * @param \Municipio\Schema\Contracts\RecipeContract|\Municipio\Schema\Contracts\RecipeContract[] $recipe
     *
     * @return static
     *
