...
use \Municipio\Schema\Contracts\DownloadActionContract;
 ...
 *
 */
class DownloadAction extends BaseType implements DownloadActionContract, ActionContract, ThingContract, TransferActionContract
{
    /**
