...
use \Municipio\Schema\Contracts\UserTweetsContract;
 ...
 *
 */
class UserTweets extends BaseType implements UserTweetsContract, EventContract, ThingContract, UserInteractionContract
{
    /**
