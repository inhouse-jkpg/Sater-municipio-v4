...
use \Municipio\Schema\Contracts\CollegeOrUniversityContract;
use \Municipio\Schema\Contracts\CivicStructureContract;
use \Municipio\Schema\Contracts\EducationalOrganizationContract;
 ...
 *
 */
class CollegeOrUniversity extends BaseType implements CollegeOrUniversityContract, CivicStructureContract, EducationalOrganizationContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
