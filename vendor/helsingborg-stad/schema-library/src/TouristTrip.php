...
use \Municipio\Schema\Contracts\TouristTripContract;
...
class TouristTrip extends BaseType implements TouristTripContract, IntangibleContract, ThingContract, TripContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AudienceContract|\Municipio\Schema\Contracts\AudienceContract[]|string|string[] $touristType
     *
     * @return static
     *
