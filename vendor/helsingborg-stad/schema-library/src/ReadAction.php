...
use \Municipio\Schema\Contracts\ReadActionContract;
 ...
 *
 */
class ReadAction extends BaseType implements ReadActionContract, ActionContract, ConsumeActionContract, ThingContract
{
    /**
