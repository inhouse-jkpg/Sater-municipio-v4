...
use \Municipio\Schema\Contracts\BarOrPubContract;
 ...
 *
 */
class BarOrPub extends BaseType implements BarOrPubContract, FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
