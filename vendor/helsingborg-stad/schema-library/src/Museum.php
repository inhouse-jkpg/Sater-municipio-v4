...
use \Municipio\Schema\Contracts\MuseumContract;
 ...
 *
 */
class Museum extends BaseType implements MuseumContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
