...
use \Municipio\Schema\Contracts\BikeStoreContract;
 ...
 *
 */
class BikeStore extends BaseType implements BikeStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
