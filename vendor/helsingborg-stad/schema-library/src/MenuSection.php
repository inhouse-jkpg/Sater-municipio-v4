...
use \Municipio\Schema\Contracts\MenuSectionContract;
...
class MenuSection extends BaseType implements MenuSectionContract, CreativeWorkContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MenuItemContract|\Municipio\Schema\Contracts\MenuItemContract[] $hasMenuItem
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MenuSectionContract|\Municipio\Schema\Contracts\MenuSectionContract[] $hasMenuSection
     *
     * @return static
     *
