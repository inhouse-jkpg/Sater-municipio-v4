...
use \Municipio\Schema\Contracts\CourseInstanceContract;
...
class CourseInstance extends BaseType implements CourseInstanceContract, EventContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\ScheduleContract|\Municipio\Schema\Contracts\ScheduleContract[] $courseSchedule
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('courseWorkload', $courseWorkload);
    }
     ...
     * [[CourseInstance]].
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $instructor
     *
     * @return static
     *
