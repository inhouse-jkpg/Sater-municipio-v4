...
use \Municipio\Schema\Contracts\AboutPageContract;
 ...
 *
 */
class AboutPage extends BaseType implements AboutPageContract, CreativeWorkContract, ThingContract, WebPageContract
{
    /**
