...
use \Municipio\Schema\Contracts\LymphaticVesselContract;
...
class LymphaticVessel extends BaseType implements LymphaticVesselContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract, VesselContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\VesselContract|\Municipio\Schema\Contracts\VesselContract[] $originatesFrom
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\VesselContract|\Municipio\Schema\Contracts\VesselContract[] $runsTo
     *
     * @return static
     *
