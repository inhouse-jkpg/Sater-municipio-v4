...
use \Municipio\Schema\Contracts\BedDetailsContract;
...
class BedDetails extends BaseType implements BedDetailsContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\BedTypeContract|\Municipio\Schema\Contracts\BedTypeContract[]|string|string[] $typeOfBed
     *
     * @return static
     *
