...
use \Municipio\Schema\Contracts\ScheduleContract;
...
class Schedule extends BaseType implements ScheduleContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DayOfWeekContract|\Municipio\Schema\Contracts\DayOfWeekContract[]|string|string[] $byDay
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[]|string|string[] $repeatFrequency
     *
     * @return static
     *
