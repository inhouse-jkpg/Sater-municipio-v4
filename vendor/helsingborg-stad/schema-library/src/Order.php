...
use \Municipio\Schema\Contracts\OrderContract;
...
class Order extends BaseType implements OrderContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OfferContract|\Municipio\Schema\Contracts\OfferContract[] $acceptedOffer
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PostalAddressContract|\Municipio\Schema\Contracts\PostalAddressContract[] $billingAddress
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $customer
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $merchant
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ParcelDeliveryContract|\Municipio\Schema\Contracts\ParcelDeliveryContract[] $orderDelivery
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrderStatusContract|\Municipio\Schema\Contracts\OrderStatusContract[] $orderStatus
     *
     * @return static
     *
     ...
     * The item ordered.
     *
     * @param \Municipio\Schema\Contracts\OrderItemContract|\Municipio\Schema\Contracts\OrderItemContract[]|\Municipio\Schema\Contracts\ProductContract|\Municipio\Schema\Contracts\ProductContract[]|\Municipio\Schema\Contracts\ServiceContract|\Municipio\Schema\Contracts\ServiceContract[] $orderedItem
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\InvoiceContract|\Municipio\Schema\Contracts\InvoiceContract[] $partOfInvoice
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PaymentMethodContract|\Municipio\Schema\Contracts\PaymentMethodContract[]|string|string[] $paymentMethod
     *
     * @return static
     *
