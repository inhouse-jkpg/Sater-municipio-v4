...
use \Municipio\Schema\Contracts\OceanBodyOfWaterContract;
 ...
 *
 */
class OceanBodyOfWater extends BaseType implements OceanBodyOfWaterContract, BodyOfWaterContract, LandformContract, PlaceContract, ThingContract
{
    /**
