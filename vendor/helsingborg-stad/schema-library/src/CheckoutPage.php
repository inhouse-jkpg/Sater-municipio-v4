...
use \Municipio\Schema\Contracts\CheckoutPageContract;
 ...
 *
 */
class CheckoutPage extends BaseType implements CheckoutPageContract, CreativeWorkContract, ThingContract, WebPageContract
{
    /**
