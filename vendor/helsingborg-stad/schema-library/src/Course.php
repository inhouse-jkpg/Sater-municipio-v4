...
use \Municipio\Schema\Contracts\CourseContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\LearningResourceContract;
 ...
 *
 */
class Course extends BaseType implements CourseContract, CreativeWorkContract, LearningResourceContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[]|string|string[] $competencyRequired
     *
     * @return static
     *
     ...
     * [[AlignmentObject]].
     *
     * @param \Municipio\Schema\Contracts\AlignmentObjectContract|\Municipio\Schema\Contracts\AlignmentObjectContract[]|\Municipio\Schema\Contracts\CourseContract|\Municipio\Schema\Contracts\CourseContract[]|string|string[] $coursePrerequisites
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\CourseInstanceContract|\Municipio\Schema\Contracts\CourseInstanceContract[] $hasCourseInstance
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\SyllabusContract|\Municipio\Schema\Contracts\SyllabusContract[] $syllabusSections
     *
     * @return static
     *
