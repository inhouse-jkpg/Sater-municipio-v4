...
use \Municipio\Schema\Contracts\MedicalCodeContract;
use \Municipio\Schema\Contracts\CategoryCodeContract;
...
use \Municipio\Schema\Contracts\MedicalIntangibleContract;
...
class MedicalCode extends BaseType implements MedicalCodeContract, CategoryCodeContract, DefinedTermContract, IntangibleContract, MedicalEntityContract, MedicalIntangibleContract, ThingContract
{
    ...
    {
        return $this->setProperty('codingSystem', $codingSystem);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\CategoryCodeSetContract|\Municipio\Schema\Contracts\CategoryCodeSetContract[]|string|string[] $inCodeSet
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermSetContract|\Municipio\Schema\Contracts\DefinedTermSetContract[]|string|string[] $inDefinedTermSet
     *
     * @return static
     *
