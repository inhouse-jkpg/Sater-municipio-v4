...
use \Municipio\Schema\Contracts\EventVenueContract;
 ...
 *
 */
class EventVenue extends BaseType implements EventVenueContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
