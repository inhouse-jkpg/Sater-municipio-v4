...
use \Municipio\Schema\Contracts\DrinkActionContract;
 ...
 *
 */
class DrinkAction extends BaseType implements DrinkActionContract, ActionContract, ConsumeActionContract, ThingContract
{
    /**
