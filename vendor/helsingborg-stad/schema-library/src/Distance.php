...
use \Municipio\Schema\Contracts\DistanceContract;
 ...
 *
 */
class Distance extends BaseType implements DistanceContract, IntangibleContract, QuantityContract, ThingContract
{
    /**
