 ...
 */
class EnergyEfficiencyEnumeration extends BaseType implements EnergyEfficiencyEnumerationContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
