...
use \Municipio\Schema\Contracts\RadioBroadcastServiceContract;
use \Municipio\Schema\Contracts\BroadcastServiceContract;
...
class RadioBroadcastService extends BaseType implements RadioBroadcastServiceContract, BroadcastServiceContract, IntangibleContract, ServiceContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $area
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $broadcastAffiliateOf
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BroadcastFrequencySpecificationContract|\Municipio\Schema\Contracts\BroadcastFrequencySpecificationContract[]|string|string[] $broadcastFrequency
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $broadcaster
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BroadcastChannelContract|\Municipio\Schema\Contracts\BroadcastChannelContract[] $hasBroadcastChannel
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BroadcastServiceContract|\Municipio\Schema\Contracts\BroadcastServiceContract[] $parentService
     *
     * @return static
     *
