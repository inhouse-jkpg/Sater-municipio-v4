...
use \Municipio\Schema\Contracts\UserLikesContract;
 ...
 *
 */
class UserLikes extends BaseType implements UserLikesContract, EventContract, ThingContract, UserInteractionContract
{
    /**
