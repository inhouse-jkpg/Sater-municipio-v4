...
use \Municipio\Schema\Contracts\PlayGameActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\ConsumeActionContract;
 ...
 *
 */
class PlayGameAction extends BaseType implements PlayGameActionContract, ActionContract, ConsumeActionContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\ActionAccessSpecificationContract|\Municipio\Schema\Contracts\ActionAccessSpecificationContract[] $actionAccessibilityRequirement
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\GameAvailabilityEnumerationContract|\Municipio\Schema\Contracts\GameAvailabilityEnumerationContract[]|string|string[] $gameAvailabilityType
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/3058
     */
    public function gameAvailabilityType($gameAvailabilityType)
    {
        return $this->setProperty('gameAvailabilityType', $gameAvailabilityType);
    }
