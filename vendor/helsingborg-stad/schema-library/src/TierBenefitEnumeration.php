...
use \Municipio\Schema\Contracts\TierBenefitEnumerationContract;
 ...
 */
class TierBenefitEnumeration extends BaseType implements TierBenefitEnumerationContract, EnumerationContract, IntangibleContract, ThingContract
{
    /**
