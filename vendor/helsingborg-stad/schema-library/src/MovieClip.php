...
use \Municipio\Schema\Contracts\MovieClipContract;
 ...
 *
 */
class MovieClip extends BaseType implements MovieClipContract, ClipContract, CreativeWorkContract, ThingContract
{
    /**
