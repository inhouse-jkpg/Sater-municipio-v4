...
use \Municipio\Schema\Contracts\IndividualPhysicianContract;
use \Municipio\Schema\Contracts\LocalBusinessContract;
use \Municipio\Schema\Contracts\MedicalBusinessContract;
use \Municipio\Schema\Contracts\MedicalOrganizationContract;
use \Municipio\Schema\Contracts\OrganizationContract;
use \Municipio\Schema\Contracts\PhysicianContract;
 ...
 *
 */
class IndividualPhysician extends BaseType implements IndividualPhysicianContract, LocalBusinessContract, MedicalBusinessContract, MedicalOrganizationContract, OrganizationContract, PhysicianContract, PlaceContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalProcedureContract|\Municipio\Schema\Contracts\MedicalProcedureContract[]|\Municipio\Schema\Contracts\MedicalTestContract|\Municipio\Schema\Contracts\MedicalTestContract[]|\Municipio\Schema\Contracts\MedicalTherapyContract|\Municipio\Schema\Contracts\MedicalTherapyContract[] $availableService
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('availableService', $availableService);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\HospitalContract|\Municipio\Schema\Contracts\HospitalContract[] $hospitalAffiliation
     *
     * @return static
     *
     ...
     * @see https://health-lifesci.schema.org
     */
    public function hospitalAffiliation($hospitalAffiliation)
    {
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalSpecialtyContract|\Municipio\Schema\Contracts\MedicalSpecialtyContract[] $medicalSpecialty
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalOrganizationContract|\Municipio\Schema\Contracts\MedicalOrganizationContract[] $practicesAt
     *
     * @return static
     *
     ...
     */
    public function practicesAt($practicesAt)
    {
        return $this->setProperty('practicesAt', $practicesAt);
    }
    ...
    {
        return $this->setProperty('usNPI', $usNPI);
    }
