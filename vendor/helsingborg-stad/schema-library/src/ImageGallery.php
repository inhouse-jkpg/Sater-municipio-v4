...
use \Municipio\Schema\Contracts\ImageGalleryContract;
use \Municipio\Schema\Contracts\CollectionPageContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\MediaGalleryContract;
 ...
 *
 */
class ImageGallery extends BaseType implements ImageGalleryContract, CollectionPageContract, CreativeWorkContract, MediaGalleryContract, ThingContract, WebPageContract
{
    /**
