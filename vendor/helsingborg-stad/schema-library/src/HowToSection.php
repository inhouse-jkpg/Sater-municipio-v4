...
class HowToSection extends BaseType implements HowToSectionContract, CreativeWorkContract, IntangibleContract, ItemListContract, ListItemContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\ListItemContract|\Municipio\Schema\Contracts\ListItemContract[]|\Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[]|string|string[] $itemListElement
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ItemListOrderTypeContract|\Municipio\Schema\Contracts\ItemListOrderTypeContract[]|string|string[] $itemListOrder
     *
     * @return static
     *
