...
use \Municipio\Schema\Contracts\QAPageContract;
 ...
 *
 */
class QAPage extends BaseType implements QAPageContract, CreativeWorkContract, ThingContract, WebPageContract
{
    /**
