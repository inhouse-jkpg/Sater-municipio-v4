...
use \Municipio\Schema\Contracts\VacationRentalContract;
use \Municipio\Schema\Contracts\LocalBusinessContract;
use \Municipio\Schema\Contracts\LodgingBusinessContract;
 ...
 *
 */
class VacationRental extends BaseType implements VacationRentalContract, LocalBusinessContract, LodgingBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
