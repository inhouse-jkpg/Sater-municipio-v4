...
use \Municipio\Schema\Contracts\ExerciseActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\PlayActionContract;
...
class ExerciseAction extends BaseType implements ExerciseActionContract, ActionContract, PlayActionContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $course
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DietContract|\Municipio\Schema\Contracts\DietContract[] $diet
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DistanceContract|\Municipio\Schema\Contracts\DistanceContract[] $distance
     *
     * @return static
     *
     ...
     * A sub property of location. The course where this action was taken.
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $exerciseCourse
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ExercisePlanContract|\Municipio\Schema\Contracts\ExercisePlanContract[] $exercisePlan
     *
     * @return static
     *
     ...
     * A sub property of instrument. The diet used in this action.
     *
     * @param \Municipio\Schema\Contracts\DietContract|\Municipio\Schema\Contracts\DietContract[] $exerciseRelatedDiet
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $fromLocation
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $opponent
     *
     * @return static
     *
     ...
     * action occurred.
     *
     * @param \Municipio\Schema\Contracts\SportsActivityLocationContract|\Municipio\Schema\Contracts\SportsActivityLocationContract[] $sportsActivityLocation
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\SportsEventContract|\Municipio\Schema\Contracts\SportsEventContract[] $sportsEvent
     *
     * @return static
     *
     ...
     * action.
     *
     * @param \Municipio\Schema\Contracts\SportsTeamContract|\Municipio\Schema\Contracts\SportsTeamContract[] $sportsTeam
     *
     * @return static
     *
     ...
     * after the action.
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $toLocation
     *
     * @return static
     *
