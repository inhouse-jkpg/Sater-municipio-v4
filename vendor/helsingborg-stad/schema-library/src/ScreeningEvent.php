...
use \Municipio\Schema\Contracts\ScreeningEventContract;
...
class ScreeningEvent extends BaseType implements ScreeningEventContract, EventContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MovieContract|\Municipio\Schema\Contracts\MovieContract[] $workPresented
     *
     * @return static
     *
