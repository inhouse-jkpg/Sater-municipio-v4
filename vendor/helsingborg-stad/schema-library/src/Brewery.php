...
use \Municipio\Schema\Contracts\BreweryContract;
 ...
 *
 */
class Brewery extends BaseType implements BreweryContract, FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
