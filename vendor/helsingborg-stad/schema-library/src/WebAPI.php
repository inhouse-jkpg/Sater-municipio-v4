...
use \Municipio\Schema\Contracts\WebAPIContract;
 ...
 *
 */
class WebAPI extends BaseType implements WebAPIContract, IntangibleContract, ServiceContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|string|string[] $documentation
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('documentation', $documentation);
    }
