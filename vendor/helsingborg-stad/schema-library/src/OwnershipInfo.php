...
use \Municipio\Schema\Contracts\OwnershipInfoContract;
...
class OwnershipInfo extends BaseType implements OwnershipInfoContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $acquiredFrom
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ProductContract|\Municipio\Schema\Contracts\ProductContract[]|\Municipio\Schema\Contracts\ServiceContract|\Municipio\Schema\Contracts\ServiceContract[] $typeOfGood
     *
     * @return static
     *
