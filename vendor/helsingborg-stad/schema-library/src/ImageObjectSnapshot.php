...
use \Municipio\Schema\Contracts\ImageObjectSnapshotContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\ImageObjectContract;
 ...
 *
 */
class ImageObjectSnapshot extends BaseType implements ImageObjectSnapshotContract, CreativeWorkContract, ImageObjectContract, MediaObjectContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\PropertyValueContract|\Municipio\Schema\Contracts\PropertyValueContract[]|string|string[] $exifData
     *
     * @return static
     *
