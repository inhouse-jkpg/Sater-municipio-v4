...
use \Municipio\Schema\Contracts\AutoRepairContract;
 ...
 *
 */
class AutoRepair extends BaseType implements AutoRepairContract, AutomotiveBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
