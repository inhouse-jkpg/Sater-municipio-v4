...
use \Municipio\Schema\Contracts\CrematoriumContract;
 ...
 *
 */
class Crematorium extends BaseType implements CrematoriumContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
