...
use \Municipio\Schema\Contracts\RealEstateAgentContract;
 ...
 *
 */
class RealEstateAgent extends BaseType implements RealEstateAgentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
