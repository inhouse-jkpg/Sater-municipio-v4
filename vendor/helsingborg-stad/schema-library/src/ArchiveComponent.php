...
use \Municipio\Schema\Contracts\ArchiveComponentContract;
 ...
 *
 */
class ArchiveComponent extends BaseType implements ArchiveComponentContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     * [[ArchiveComponent]].
     *
     * @param \Municipio\Schema\Contracts\ArchiveOrganizationContract|\Municipio\Schema\Contracts\ArchiveOrganizationContract[] $holdingArchive
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('holdingArchive', $holdingArchive);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[]|\Municipio\Schema\Contracts\PostalAddressContract|\Municipio\Schema\Contracts\PostalAddressContract[]|string|string[] $itemLocation
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('itemLocation', $itemLocation);
    }
