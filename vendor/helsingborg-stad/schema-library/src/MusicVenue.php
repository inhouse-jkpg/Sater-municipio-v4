...
use \Municipio\Schema\Contracts\MusicVenueContract;
 ...
 *
 */
class MusicVenue extends BaseType implements MusicVenueContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
