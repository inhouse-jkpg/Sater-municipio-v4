...
use \Municipio\Schema\Contracts\ChildCareContract;
 ...
 *
 */
class ChildCare extends BaseType implements ChildCareContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
