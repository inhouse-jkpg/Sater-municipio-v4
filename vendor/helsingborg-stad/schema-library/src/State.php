...
use \Municipio\Schema\Contracts\StateContract;
 ...
 *
 */
class State extends BaseType implements StateContract, AdministrativeAreaContract, PlaceContract, ThingContract
{
    /**
