...
use \Municipio\Schema\Contracts\GeneContract;
...
class Gene extends BaseType implements GeneContract, BioChemEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\GeneContract|\Municipio\Schema\Contracts\GeneContract[] $alternativeOf
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('alternativeOf', $alternativeOf);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\BioChemEntityContract|\Municipio\Schema\Contracts\BioChemEntityContract[] $encodesBioChemEntity
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('encodesBioChemEntity', $encodesBioChemEntity);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[]|\Municipio\Schema\Contracts\AnatomicalSystemContract|\Municipio\Schema\Contracts\AnatomicalSystemContract[]|\Municipio\Schema\Contracts\BioChemEntityContract|\Municipio\Schema\Contracts\BioChemEntityContract[]|\Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[] $expressedIn
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('expressedIn', $expressedIn);
    }
