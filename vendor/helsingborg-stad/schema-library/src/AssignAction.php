...
use \Municipio\Schema\Contracts\AssignActionContract;
 ...
 *
 */
class AssignAction extends BaseType implements AssignActionContract, ActionContract, AllocateActionContract, OrganizeActionContract, ThingContract
{
    /**
