 ...
 *
 */
class SportsActivityLocation extends BaseType implements SportsActivityLocationContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
