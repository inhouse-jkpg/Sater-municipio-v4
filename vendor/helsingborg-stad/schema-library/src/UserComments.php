...
use \Municipio\Schema\Contracts\UserCommentsContract;
use \Municipio\Schema\Contracts\EventContract;
use \Municipio\Schema\Contracts\ThingContract;
use \Municipio\Schema\Contracts\UserInteractionContract;
 ...
 *
 */
class UserComments extends BaseType implements UserCommentsContract, EventContract, ThingContract, UserInteractionContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $discusses
     *
     * @return static
     *
