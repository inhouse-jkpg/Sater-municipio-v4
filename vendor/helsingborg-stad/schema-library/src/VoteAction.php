...
use \Municipio\Schema\Contracts\VoteActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\AssessActionContract;
use \Municipio\Schema\Contracts\ChooseActionContract;
...
class VoteAction extends BaseType implements VoteActionContract, ActionContract, AssessActionContract, ChooseActionContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[]|string|string[] $actionOption
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $candidate
     *
     * @return static
     *
     ...
     * A sub property of object. The options subject to this action.
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[]|string|string[] $option
     *
     * @return static
     *
