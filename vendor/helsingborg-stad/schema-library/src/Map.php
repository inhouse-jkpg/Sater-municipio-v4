...
use \Municipio\Schema\Contracts\MapContract;
...
class Map extends BaseType implements MapContract, CreativeWorkContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MapCategoryTypeContract|\Municipio\Schema\Contracts\MapCategoryTypeContract[] $mapType
     *
     * @return static
     *
