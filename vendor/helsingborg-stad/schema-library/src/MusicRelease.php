...
use \Municipio\Schema\Contracts\MusicReleaseContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\MusicPlaylistContract;
...
class MusicRelease extends BaseType implements MusicReleaseContract, CreativeWorkContract, MusicPlaylistContract, ThingContract
{
     ...
     * Lady Gaga.
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $creditedTo
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicReleaseFormatTypeContract|\Municipio\Schema\Contracts\MusicReleaseFormatTypeContract[] $musicReleaseFormat
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $recordLabel
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicAlbumContract|\Municipio\Schema\Contracts\MusicAlbumContract[] $releaseOf
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ItemListContract|\Municipio\Schema\Contracts\ItemListContract[]|\Municipio\Schema\Contracts\MusicRecordingContract|\Municipio\Schema\Contracts\MusicRecordingContract[] $track
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicRecordingContract|\Municipio\Schema\Contracts\MusicRecordingContract[] $tracks
     *
     * @return static
     *
