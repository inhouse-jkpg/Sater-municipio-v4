...
use \Municipio\Schema\Contracts\HinduTempleContract;
 ...
 *
 */
class HinduTemple extends BaseType implements HinduTempleContract, CivicStructureContract, PlaceContract, PlaceOfWorshipContract, ThingContract
{
    /**
