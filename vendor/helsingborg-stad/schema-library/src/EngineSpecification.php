...
use \Municipio\Schema\Contracts\EngineSpecificationContract;
...
class EngineSpecification extends BaseType implements EngineSpecificationContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $engineDisplacement
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $enginePower
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|string|string[] $engineType
     *
     * @return static
     *
     ...
     * * Note 2: You can use [[minValue]] and [[maxValue]] to indicate ranges.
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $torque
     *
     * @return static
     *
