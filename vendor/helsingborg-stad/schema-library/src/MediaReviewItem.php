...
use \Municipio\Schema\Contracts\MediaReviewItemContract;
 ...
 *
 */
class MediaReviewItem extends BaseType implements MediaReviewItemContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\MediaObjectContract|\Municipio\Schema\Contracts\MediaObjectContract[] $mediaItemAppearance
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/2450
     */
    public function mediaItemAppearance($mediaItemAppearance)
    {
        return $this->setProperty('mediaItemAppearance', $mediaItemAppearance);
    }
