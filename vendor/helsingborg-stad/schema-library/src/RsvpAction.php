...
use \Municipio\Schema\Contracts\RsvpActionContract;
use \Municipio\Schema\Contracts\ActionContract;
use \Municipio\Schema\Contracts\CommunicateActionContract;
use \Municipio\Schema\Contracts\InformActionContract;
use \Municipio\Schema\Contracts\InteractActionContract;
...
class RsvpAction extends BaseType implements RsvpActionContract, ActionContract, CommunicateActionContract, InformActionContract, InteractActionContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\LanguageContract|\Municipio\Schema\Contracts\LanguageContract[] $language
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\RsvpResponseTypeContract|\Municipio\Schema\Contracts\RsvpResponseTypeContract[] $rsvpResponse
     *
     * @return static
     *
