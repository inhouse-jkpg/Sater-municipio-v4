...
use \Municipio\Schema\Contracts\SchoolContract;
 ...
 *
 */
class School extends BaseType implements SchoolContract, CivicStructureContract, EducationalOrganizationContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
