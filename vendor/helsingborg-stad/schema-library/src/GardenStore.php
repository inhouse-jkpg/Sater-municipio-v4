...
use \Municipio\Schema\Contracts\GardenStoreContract;
 ...
 *
 */
class GardenStore extends BaseType implements GardenStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
