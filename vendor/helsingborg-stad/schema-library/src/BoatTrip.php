...
use \Municipio\Schema\Contracts\BoatTripContract;
...
class BoatTrip extends BaseType implements BoatTripContract, IntangibleContract, ThingContract, TripContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\BoatTerminalContract|\Municipio\Schema\Contracts\BoatTerminalContract[] $arrivalBoatTerminal
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BoatTerminalContract|\Municipio\Schema\Contracts\BoatTerminalContract[] $departureBoatTerminal
     *
     * @return static
     *
