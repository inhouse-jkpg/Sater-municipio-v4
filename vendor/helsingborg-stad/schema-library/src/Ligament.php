...
use \Municipio\Schema\Contracts\LigamentContract;
 ...
 *
 */
class Ligament extends BaseType implements LigamentContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract
{
    /**
