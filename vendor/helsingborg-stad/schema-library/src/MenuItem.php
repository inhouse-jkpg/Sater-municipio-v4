...
use \Municipio\Schema\Contracts\MenuItemContract;
...
class MenuItem extends BaseType implements MenuItemContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MenuItemContract|\Municipio\Schema\Contracts\MenuItemContract[]|\Municipio\Schema\Contracts\MenuSectionContract|\Municipio\Schema\Contracts\MenuSectionContract[] $menuAddOn
     *
     * @return static
     *
