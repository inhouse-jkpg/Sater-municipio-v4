...
use \Municipio\Schema\Contracts\ReviewNewsArticleContract;
use \Municipio\Schema\Contracts\ArticleContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\CriticReviewContract;
use \Municipio\Schema\Contracts\NewsArticleContract;
 ...
 *
 */
class ReviewNewsArticle extends BaseType implements ReviewNewsArticleContract, ArticleContract, CreativeWorkContract, CriticReviewContract, NewsArticleContract, ReviewContract, ThingContract
{
    /**
     ...
     * etc.
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|string|string[] $backstory
     *
     * @return static
     *
