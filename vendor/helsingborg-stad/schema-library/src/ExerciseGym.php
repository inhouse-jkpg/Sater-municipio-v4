...
use \Municipio\Schema\Contracts\ExerciseGymContract;
 ...
 *
 */
class ExerciseGym extends BaseType implements ExerciseGymContract, LocalBusinessContract, OrganizationContract, PlaceContract, SportsActivityLocationContract, ThingContract
{
    /**
