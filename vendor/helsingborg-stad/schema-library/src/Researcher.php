...
use \Municipio\Schema\Contracts\ResearcherContract;
 ...
 *
 */
class Researcher extends BaseType implements ResearcherContract, AudienceContract, IntangibleContract, ThingContract
{
    /**
