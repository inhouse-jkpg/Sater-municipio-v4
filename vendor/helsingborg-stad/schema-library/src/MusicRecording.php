...
use \Municipio\Schema\Contracts\MusicRecordingContract;
...
class MusicRecording extends BaseType implements MusicRecordingContract, CreativeWorkContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicAlbumContract|\Municipio\Schema\Contracts\MusicAlbumContract[] $inAlbum
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicPlaylistContract|\Municipio\Schema\Contracts\MusicPlaylistContract[] $inPlaylist
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicCompositionContract|\Municipio\Schema\Contracts\MusicCompositionContract[] $recordingOf
     *
     * @return static
     *
