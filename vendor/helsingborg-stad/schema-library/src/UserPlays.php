...
use \Municipio\Schema\Contracts\UserPlaysContract;
 ...
 *
 */
class UserPlays extends BaseType implements UserPlaysContract, EventContract, ThingContract, UserInteractionContract
{
    /**
