...
use \Municipio\Schema\Contracts\SubwayStationContract;
 ...
 *
 */
class SubwayStation extends BaseType implements SubwayStationContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
