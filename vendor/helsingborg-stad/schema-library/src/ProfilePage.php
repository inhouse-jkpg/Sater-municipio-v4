...
use \Municipio\Schema\Contracts\ProfilePageContract;
 ...
 *
 */
class ProfilePage extends BaseType implements ProfilePageContract, CreativeWorkContract, ThingContract, WebPageContract
{
    /**
