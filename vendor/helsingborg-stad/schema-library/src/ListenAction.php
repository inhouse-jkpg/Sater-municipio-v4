...
use \Municipio\Schema\Contracts\ListenActionContract;
 ...
 *
 */
class ListenAction extends BaseType implements ListenActionContract, ActionContract, ConsumeActionContract, ThingContract
{
    /**
