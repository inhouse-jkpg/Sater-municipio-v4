...
use \Municipio\Schema\Contracts\ToyStoreContract;
 ...
 *
 */
class ToyStore extends BaseType implements ToyStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
