...
use \Municipio\Schema\Contracts\MusicAlbumContract;
...
class MusicAlbum extends BaseType implements MusicAlbumContract, CreativeWorkContract, MusicPlaylistContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicAlbumProductionTypeContract|\Municipio\Schema\Contracts\MusicAlbumProductionTypeContract[] $albumProductionType
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicReleaseContract|\Municipio\Schema\Contracts\MusicReleaseContract[] $albumRelease
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicAlbumReleaseTypeContract|\Municipio\Schema\Contracts\MusicAlbumReleaseTypeContract[] $albumReleaseType
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicGroupContract|\Municipio\Schema\Contracts\MusicGroupContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $byArtist
     *
     * @return static
     *
