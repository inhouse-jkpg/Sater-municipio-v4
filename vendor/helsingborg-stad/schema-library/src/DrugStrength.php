...
use \Municipio\Schema\Contracts\DrugStrengthContract;
...
class DrugStrength extends BaseType implements DrugStrengthContract, MedicalEntityContract, MedicalIntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AdministrativeAreaContract|\Municipio\Schema\Contracts\AdministrativeAreaContract[] $availableIn
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('availableIn', $availableIn);
    }
    ...
    {
        return $this->setProperty('strengthUnit', $strengthUnit);
    }
    ...
    {
        return $this->setProperty('strengthValue', $strengthValue);
    }
