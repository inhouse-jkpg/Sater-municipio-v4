...
use \Municipio\Schema\Contracts\MusicCompositionContract;
...
class MusicComposition extends BaseType implements MusicCompositionContract, CreativeWorkContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $composer
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\EventContract|\Municipio\Schema\Contracts\EventContract[] $firstPerformance
     *
     * @return static
     *
     ...
     * symphony).
     *
     * @param \Municipio\Schema\Contracts\MusicCompositionContract|\Municipio\Schema\Contracts\MusicCompositionContract[] $includedComposition
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $lyricist
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $lyrics
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicCompositionContract|\Municipio\Schema\Contracts\MusicCompositionContract[] $musicArrangement
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MusicRecordingContract|\Municipio\Schema\Contracts\MusicRecordingContract[] $recordedAs
     *
     * @return static
     *
