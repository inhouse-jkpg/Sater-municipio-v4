...
use \Municipio\Schema\Contracts\ContinentContract;
 ...
 *
 */
class Continent extends BaseType implements ContinentContract, LandformContract, PlaceContract, ThingContract
{
    /**
