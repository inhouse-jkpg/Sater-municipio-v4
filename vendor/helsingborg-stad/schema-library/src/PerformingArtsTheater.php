...
use \Municipio\Schema\Contracts\PerformingArtsTheaterContract;
 ...
 *
 */
class PerformingArtsTheater extends BaseType implements PerformingArtsTheaterContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
