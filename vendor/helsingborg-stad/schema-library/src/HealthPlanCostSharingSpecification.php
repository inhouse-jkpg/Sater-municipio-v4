...
use \Municipio\Schema\Contracts\HealthPlanCostSharingSpecificationContract;
...
class HealthPlanCostSharingSpecification extends BaseType implements HealthPlanCostSharingSpecificationContract, IntangibleContract, ThingContract
{
     ...
     * The copay amount.
     *
     * @param \Municipio\Schema\Contracts\PriceSpecificationContract|\Municipio\Schema\Contracts\PriceSpecificationContract[] $healthPlanCopay
     *
     * @return static
     *
