...
use \Municipio\Schema\Contracts\QuestionContract;
use \Municipio\Schema\Contracts\CommentContract;
...
class Question extends BaseType implements QuestionContract, CommentContract, CreativeWorkContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AnswerContract|\Municipio\Schema\Contracts\AnswerContract[]|\Municipio\Schema\Contracts\ItemListContract|\Municipio\Schema\Contracts\ItemListContract[] $acceptedAnswer
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\CommentContract|\Municipio\Schema\Contracts\CommentContract[]|\Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $parentItem
     *
     * @return static
     *
     ...
     * this posting.
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $sharedContent
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\AnswerContract|\Municipio\Schema\Contracts\AnswerContract[]|\Municipio\Schema\Contracts\ItemListContract|\Municipio\Schema\Contracts\ItemListContract[] $suggestedAnswer
     *
     * @return static
     *
