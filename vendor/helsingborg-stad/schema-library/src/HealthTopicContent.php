...
use \Municipio\Schema\Contracts\HealthTopicContentContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\ThingContract;
use \Municipio\Schema\Contracts\WebContentContract;
 ...
 *
 */
class HealthTopicContent extends BaseType implements HealthTopicContentContract, CreativeWorkContract, ThingContract, WebContentContract
{
    /**
     ...
     * side-effects.
     *
     * @param \Municipio\Schema\Contracts\HealthAspectEnumerationContract|\Municipio\Schema\Contracts\HealthAspectEnumerationContract[] $hasHealthAspect
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('hasHealthAspect', $hasHealthAspect);
    }
