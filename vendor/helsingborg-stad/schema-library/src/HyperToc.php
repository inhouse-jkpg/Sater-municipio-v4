...
use \Municipio\Schema\Contracts\HyperTocContract;
 ...
 *
 */
class HyperToc extends BaseType implements HyperTocContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\HyperTocEntryContract|\Municipio\Schema\Contracts\HyperTocEntryContract[] $tocEntry
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/2766
     */
    public function tocEntry($tocEntry)
    {
        return $this->setProperty('tocEntry', $tocEntry);
    }
