...
use \Municipio\Schema\Contracts\CreditCardContract;
use \Municipio\Schema\Contracts\FinancialProductContract;
use \Municipio\Schema\Contracts\IntangibleContract;
use \Municipio\Schema\Contracts\LoanOrCreditContract;
use \Municipio\Schema\Contracts\PaymentCardContract;
use \Municipio\Schema\Contracts\PaymentMethodContract;
use \Municipio\Schema\Contracts\ServiceContract;
...
class CreditCard extends BaseType implements CreditCardContract, FinancialProductContract, IntangibleContract, LoanOrCreditContract, PaymentCardContract, PaymentMethodContract, ServiceContract, ThingContract
{
     ...
     * The amount of money.
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|float|float[]|int|int[] $amount
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|float|float[]|int|int[] $annualPercentageRate
     *
     * @return static
     *
     ...
     * location, etc.).
     *
     * @param \Municipio\Schema\Contracts\ServiceChannelContract|\Municipio\Schema\Contracts\ServiceChannelContract[] $availableChannel
     *
     * @return static
     *
     ...
     * must be authorized.
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[] $floorLimit
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DurationContract|\Municipio\Schema\Contracts\DurationContract[] $gracePeriod
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[]|float|float[]|int|int[] $interestRate
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\RepaymentSpecificationContract|\Municipio\Schema\Contracts\RepaymentSpecificationContract[] $loanRepaymentForm
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $loanTerm
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|float|float[]|int|int[] $monthlyMinimumRepaymentAmount
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PaymentMethodTypeContract|\Municipio\Schema\Contracts\PaymentMethodTypeContract[] $paymentMethodType
     *
     * @return static
     *
     ...
     * etc.
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $produces
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[]|string|string[] $requiredCollateral
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\AudienceContract|\Municipio\Schema\Contracts\AudienceContract[] $serviceAudience
     *
     * @return static
     *
     ...
     * etc.
     *
     * @param \Municipio\Schema\Contracts\ThingContract|\Municipio\Schema\Contracts\ThingContract[] $serviceOutput
     *
     * @return static
     *
     ...
     * relief, etc.
     *
     * @param \Municipio\Schema\Contracts\GovernmentBenefitsTypeContract|\Municipio\Schema\Contracts\GovernmentBenefitsTypeContract[]|string|string[] $serviceType
     *
     * @return static
     *
