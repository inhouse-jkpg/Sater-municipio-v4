...
use \Municipio\Schema\Contracts\ExchangeRateSpecificationContract;
...
class ExchangeRateSpecification extends BaseType implements ExchangeRateSpecificationContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\UnitPriceSpecificationContract|\Municipio\Schema\Contracts\UnitPriceSpecificationContract[] $currentExchangeRate
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('currentExchangeRate', $currentExchangeRate);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|float|float[]|int|int[] $exchangeRateSpread
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('exchangeRateSpread', $exchangeRateSpread);
    }
