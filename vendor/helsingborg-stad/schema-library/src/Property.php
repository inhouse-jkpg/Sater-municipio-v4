...
use \Municipio\Schema\Contracts\PropertyContract;
 ...
 */
class Property extends BaseType implements PropertyContract, IntangibleContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\PropertyContract|\Municipio\Schema\Contracts\PropertyContract[] $inverseOf
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('inverseOf', $inverseOf);
    }
