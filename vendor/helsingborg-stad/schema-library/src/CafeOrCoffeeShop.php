...
use \Municipio\Schema\Contracts\CafeOrCoffeeShopContract;
 ...
 *
 */
class CafeOrCoffeeShop extends BaseType implements CafeOrCoffeeShopContract, FoodEstablishmentContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
