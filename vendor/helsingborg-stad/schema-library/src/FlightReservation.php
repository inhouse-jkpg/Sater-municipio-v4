...
use \Municipio\Schema\Contracts\FlightReservationContract;
...
class FlightReservation extends BaseType implements FlightReservationContract, IntangibleContract, ReservationContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|string|string[] $passengerPriorityStatus
     *
     * @return static
     *
