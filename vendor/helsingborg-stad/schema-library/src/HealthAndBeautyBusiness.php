 ...
 *
 */
class HealthAndBeautyBusiness extends BaseType implements HealthAndBeautyBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
