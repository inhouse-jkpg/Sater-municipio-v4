...
use \Municipio\Schema\Contracts\PodcastEpisodeContract;
 ...
 *
 */
class PodcastEpisode extends BaseType implements PodcastEpisodeContract, CreativeWorkContract, EpisodeContract, ThingContract
{
    /**
