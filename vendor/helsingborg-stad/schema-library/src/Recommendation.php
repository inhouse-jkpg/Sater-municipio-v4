...
use \Municipio\Schema\Contracts\RecommendationContract;
 ...
 *
 */
class Recommendation extends BaseType implements RecommendationContract, CreativeWorkContract, ReviewContract, ThingContract
{
    /**
