...
use \Municipio\Schema\Contracts\NewsMediaOrganizationContract;
 ...
 *
 */
class NewsMediaOrganization extends BaseType implements NewsMediaOrganizationContract, OrganizationContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|string|string[] $masthead
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/1525
     */
    public function masthead($masthead)
    {
        return $this->setProperty('masthead', $masthead);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|string|string[] $missionCoveragePrioritiesPolicy
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/1525
     */
    public function missionCoveragePrioritiesPolicy($missionCoveragePrioritiesPolicy)
    {
        return $this->setProperty('missionCoveragePrioritiesPolicy', $missionCoveragePrioritiesPolicy);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|string|string[] $noBylinesPolicy
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/1688
     */
    public function noBylinesPolicy($noBylinesPolicy)
    {
        return $this->setProperty('noBylinesPolicy', $noBylinesPolicy);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|string|string[] $verificationFactCheckingPolicy
     *
     * @return static
     *
