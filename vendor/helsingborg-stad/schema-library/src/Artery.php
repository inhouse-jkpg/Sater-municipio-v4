...
use \Municipio\Schema\Contracts\ArteryContract;
...
class Artery extends BaseType implements ArteryContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract, VesselContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[] $arterialBranch
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('arterialBranch', $arterialBranch);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[] $supplyTo
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('supplyTo', $supplyTo);
    }
