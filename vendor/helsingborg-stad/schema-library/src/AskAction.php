...
use \Municipio\Schema\Contracts\AskActionContract;
...
class AskAction extends BaseType implements AskActionContract, ActionContract, CommunicateActionContract, InteractActionContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QuestionContract|\Municipio\Schema\Contracts\QuestionContract[] $question
     *
     * @return static
     *
