...
use \Municipio\Schema\Contracts\ResearchProjectContract;
use \Municipio\Schema\Contracts\OrganizationContract;
use \Municipio\Schema\Contracts\ProjectContract;
...
class ResearchProject extends BaseType implements ResearchProjectContract, OrganizationContract, ProjectContract, ThingContract
{
     ...
     * The project status.
     *
     * @param \Municipio\Schema\Contracts\ProgressStatusContract|\Municipio\Schema\Contracts\ProgressStatusContract[] $status
     *
     * @return static
     *
