...
use \Municipio\Schema\Contracts\InteractionCounterContract;
...
class InteractionCounter extends BaseType implements InteractionCounterContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\SoftwareApplicationContract|\Municipio\Schema\Contracts\SoftwareApplicationContract[]|\Municipio\Schema\Contracts\WebSiteContract|\Municipio\Schema\Contracts\WebSiteContract[] $interactionService
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ActionContract|\Municipio\Schema\Contracts\ActionContract[] $interactionType
     *
     * @return static
     *
