...
use \Municipio\Schema\Contracts\SyllabusContract;
 ...
 *
 */
class Syllabus extends BaseType implements SyllabusContract, CreativeWorkContract, LearningResourceContract, ThingContract
{
    /**
