...
use \Municipio\Schema\Contracts\ClaimContract;
 ...
 *
 */
class Claim extends BaseType implements ClaimContract, CreativeWorkContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $appearance
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('appearance', $appearance);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $claimInterpreter
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('claimInterpreter', $claimInterpreter);
    }
     ...
     * [[CreativeWork]].
     *
     * @param \Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[] $firstAppearance
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('firstAppearance', $firstAppearance);
    }
