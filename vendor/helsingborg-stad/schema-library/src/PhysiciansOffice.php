...
use \Municipio\Schema\Contracts\PhysiciansOfficeContract;
 ...
 *
 */
class PhysiciansOffice extends BaseType implements PhysiciansOfficeContract, LocalBusinessContract, MedicalBusinessContract, MedicalOrganizationContract, OrganizationContract, PhysicianContract, PlaceContract, ThingContract
{
    /**
