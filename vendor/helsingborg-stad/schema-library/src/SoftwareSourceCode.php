...
use \Municipio\Schema\Contracts\SoftwareSourceCodeContract;
...
class SoftwareSourceCode extends BaseType implements SoftwareSourceCodeContract, CreativeWorkContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\ComputerLanguageContract|\Municipio\Schema\Contracts\ComputerLanguageContract[]|string|string[] $programmingLanguage
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\SoftwareApplicationContract|\Municipio\Schema\Contracts\SoftwareApplicationContract[] $targetProduct
     *
     * @return static
     *
