...
use \Municipio\Schema\Contracts\SeaBodyOfWaterContract;
 ...
 *
 */
class SeaBodyOfWater extends BaseType implements SeaBodyOfWaterContract, BodyOfWaterContract, LandformContract, PlaceContract, ThingContract
{
    /**
