...
use \Municipio\Schema\Contracts\ProductModelContract;
...
class ProductModel extends BaseType implements ProductModelContract, ProductContract, ThingContract
{
     ...
     * its newer variant.
     *
     * @param \Municipio\Schema\Contracts\ProductModelContract|\Municipio\Schema\Contracts\ProductModelContract[] $predecessorOf
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ProductModelContract|\Municipio\Schema\Contracts\ProductModelContract[] $successorOf
     *
     * @return static
     *
