...
use \Municipio\Schema\Contracts\WriteActionContract;
 ...
 *
 */
class WriteAction extends BaseType implements WriteActionContract, ActionContract, CreateActionContract, ThingContract
{
    /**
