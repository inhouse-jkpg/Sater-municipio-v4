...
use \Municipio\Schema\Contracts\MedicalTestPanelContract;
...
class MedicalTestPanel extends BaseType implements MedicalTestPanelContract, MedicalEntityContract, MedicalTestContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\MedicalTestContract|\Municipio\Schema\Contracts\MedicalTestContract[] $subTest
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('subTest', $subTest);
    }
