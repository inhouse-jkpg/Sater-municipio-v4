...
use \Municipio\Schema\Contracts\JobPostingContract;
...
class JobPosting extends BaseType implements JobPostingContract, IntangibleContract, ThingContract
{
     ...
     * requirements.
     *
     * @param \Municipio\Schema\Contracts\AdministrativeAreaContract|\Municipio\Schema\Contracts\AdministrativeAreaContract[] $applicantLocationRequirements
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\ContactPointContract|\Municipio\Schema\Contracts\ContactPointContract[] $applicationContact
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\MonetaryAmountContract|\Municipio\Schema\Contracts\MonetaryAmountContract[]|\Municipio\Schema\Contracts\PriceSpecificationContract|\Municipio\Schema\Contracts\PriceSpecificationContract[]|float|float[]|int|int[] $baseSalary
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[] $employmentUnit
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $hiringOrganization
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[]|string|string[] $industry
     *
     * @return static
     *
     ...
     * position.
     *
     * @param \Municipio\Schema\Contracts\PlaceContract|\Municipio\Schema\Contracts\PlaceContract[] $jobLocation
     *
     * @return static
     *
     ...
     * defined term.
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[]|string|string[] $physicalRequirement
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\OccupationContract|\Municipio\Schema\Contracts\OccupationContract[] $relevantOccupation
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DefinedTermContract|\Municipio\Schema\Contracts\DefinedTermContract[]|string|string[] $sensoryRequirement
     *
     * @return static
     *
