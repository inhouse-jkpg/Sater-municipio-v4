...
use \Municipio\Schema\Contracts\AMRadioChannelContract;
use \Municipio\Schema\Contracts\BroadcastChannelContract;
use \Municipio\Schema\Contracts\IntangibleContract;
use \Municipio\Schema\Contracts\RadioChannelContract;
 ...
 *
 */
class AMRadioChannel extends BaseType implements AMRadioChannelContract, BroadcastChannelContract, IntangibleContract, RadioChannelContract, ThingContract
{
    /**
     ...
     *
     * @param \Municipio\Schema\Contracts\CableOrSatelliteServiceContract|\Municipio\Schema\Contracts\CableOrSatelliteServiceContract[] $inBroadcastLineup
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\BroadcastServiceContract|\Municipio\Schema\Contracts\BroadcastServiceContract[] $providesBroadcastService
     *
     * @return static
     *
