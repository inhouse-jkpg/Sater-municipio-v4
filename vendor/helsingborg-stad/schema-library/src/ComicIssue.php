...
use \Municipio\Schema\Contracts\ComicIssueContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\PublicationIssueContract;
...
class ComicIssue extends BaseType implements ComicIssueContract, CreativeWorkContract, PublicationIssueContract, ThingContract
{
    ...
    {
        return $this->setProperty('variantCover', $variantCover);
    }
