...
use \Municipio\Schema\Contracts\TrainStationContract;
 ...
 *
 */
class TrainStation extends BaseType implements TrainStationContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
