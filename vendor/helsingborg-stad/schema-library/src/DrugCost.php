...
use \Municipio\Schema\Contracts\DrugCostContract;
...
class DrugCost extends BaseType implements DrugCostContract, MedicalEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AdministrativeAreaContract|\Municipio\Schema\Contracts\AdministrativeAreaContract[] $applicableLocation
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('applicableLocation', $applicableLocation);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\DrugCostCategoryContract|\Municipio\Schema\Contracts\DrugCostCategoryContract[] $costCategory
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('costCategory', $costCategory);
    }
    ...
    {
        return $this->setProperty('costCurrency', $costCurrency);
    }
    ...
    {
        return $this->setProperty('costOrigin', $costOrigin);
    }

    /**
     * The cost per unit of the drug.
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|float|float[]|int|int[]|string|string[] $costPerUnit
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('costPerUnit', $costPerUnit);
    }
