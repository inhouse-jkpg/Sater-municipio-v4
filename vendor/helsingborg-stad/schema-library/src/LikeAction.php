...
use \Municipio\Schema\Contracts\LikeActionContract;
 ...
 *
 */
class LikeAction extends BaseType implements LikeActionContract, ActionContract, AssessActionContract, ReactActionContract, ThingContract
{
    /**
