...
use \Municipio\Schema\Contracts\MonetaryGrantContract;
use \Municipio\Schema\Contracts\GrantContract;
...
class MonetaryGrant extends BaseType implements MonetaryGrantContract, GrantContract, IntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\BioChemEntityContract|\Municipio\Schema\Contracts\BioChemEntityContract[]|\Municipio\Schema\Contracts\CreativeWorkContract|\Municipio\Schema\Contracts\CreativeWorkContract[]|\Municipio\Schema\Contracts\EventContract|\Municipio\Schema\Contracts\EventContract[]|\Municipio\Schema\Contracts\MedicalEntityContract|\Municipio\Schema\Contracts\MedicalEntityContract[]|\Municipio\Schema\Contracts\OrganizationContract|\Municipio\Schema\Contracts\OrganizationContract[]|\Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[]|\Municipio\Schema\Contracts\ProductContract|\Municipio\Schema\Contracts\ProductContract[] $fundedItem
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('fundedItem', $fundedItem);
    }
