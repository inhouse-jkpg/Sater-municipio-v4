...
use \Municipio\Schema\Contracts\BusOrCoachContract;
...
class BusOrCoach extends BaseType implements BusOrCoachContract, ProductContract, ThingContract, VehicleContract
{
     ...
     * ranges.
     *
     * @param \Municipio\Schema\Contracts\QuantitativeValueContract|\Municipio\Schema\Contracts\QuantitativeValueContract[] $roofLoad
     *
     * @return static
     *
