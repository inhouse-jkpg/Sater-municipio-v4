...
use \Municipio\Schema\Contracts\MathSolverContract;
...
class MathSolver extends BaseType implements MathSolverContract, CreativeWorkContract, ThingContract
{
     ...
     * keyboard.
     *
     * @param \Municipio\Schema\Contracts\SolveMathActionContract|\Municipio\Schema\Contracts\SolveMathActionContract[]|string|string[] $mathExpression
     *
     * @return static
     *
     ...
     * @link https://github.com/schemaorg/schemaorg/issues/2740
     */
    public function mathExpression($mathExpression)
    {
        return $this->setProperty('mathExpression', $mathExpression);
    }
