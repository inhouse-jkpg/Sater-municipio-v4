...
use \Municipio\Schema\Contracts\DefinedRegionContract;
...
class DefinedRegion extends BaseType implements DefinedRegionContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\PostalCodeRangeSpecificationContract|\Municipio\Schema\Contracts\PostalCodeRangeSpecificationContract[] $postalCodeRange
     *
     * @return static
     *
