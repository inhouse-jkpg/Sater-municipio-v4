...
use \Municipio\Schema\Contracts\WantActionContract;
 ...
 *
 */
class WantAction extends BaseType implements WantActionContract, ActionContract, AssessActionContract, ReactActionContract, ThingContract
{
    /**
