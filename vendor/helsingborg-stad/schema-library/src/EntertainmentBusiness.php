 ...
 *
 */
class EntertainmentBusiness extends BaseType implements EntertainmentBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
