...
use \Municipio\Schema\Contracts\GatedResidenceCommunityContract;
use \Municipio\Schema\Contracts\PlaceContract;
use \Municipio\Schema\Contracts\ResidenceContract;
 ...
 *
 */
class GatedResidenceCommunity extends BaseType implements GatedResidenceCommunityContract, PlaceContract, ResidenceContract, ThingContract
{
    /**
