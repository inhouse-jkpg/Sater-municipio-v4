...
use \Municipio\Schema\Contracts\WaterfallContract;
 ...
 *
 */
class Waterfall extends BaseType implements WaterfallContract, BodyOfWaterContract, LandformContract, PlaceContract, ThingContract
{
    /**
