...
use \Municipio\Schema\Contracts\RecyclingCenterContract;
 ...
 *
 */
class RecyclingCenter extends BaseType implements RecyclingCenterContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
