...
use \Municipio\Schema\Contracts\QuizContract;
 ...
 *
 */
class Quiz extends BaseType implements QuizContract, CreativeWorkContract, LearningResourceContract, ThingContract
{
    /**
