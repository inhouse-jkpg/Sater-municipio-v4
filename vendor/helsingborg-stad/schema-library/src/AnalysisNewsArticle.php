...
use \Municipio\Schema\Contracts\AnalysisNewsArticleContract;
 ...
 *
 */
class AnalysisNewsArticle extends BaseType implements AnalysisNewsArticleContract, ArticleContract, CreativeWorkContract, NewsArticleContract, ThingContract
{
    /**
