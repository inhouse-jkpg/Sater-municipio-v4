...
use \Municipio\Schema\Contracts\BusReservationContract;
 ...
 *
 */
class BusReservation extends BaseType implements BusReservationContract, IntangibleContract, ReservationContract, ThingContract
{
    /**
