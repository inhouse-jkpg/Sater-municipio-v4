...
use \Municipio\Schema\Contracts\CorrectionCommentContract;
 ...
 *
 */
class CorrectionComment extends BaseType implements CorrectionCommentContract, CommentContract, CreativeWorkContract, ThingContract
{
    /**
