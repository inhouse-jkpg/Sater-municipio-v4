...
use \Municipio\Schema\Contracts\PresentationDigitalDocumentContract;
use \Municipio\Schema\Contracts\CreativeWorkContract;
use \Municipio\Schema\Contracts\DigitalDocumentContract;
...
class PresentationDigitalDocument extends BaseType implements PresentationDigitalDocumentContract, CreativeWorkContract, DigitalDocumentContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\DigitalDocumentPermissionContract|\Municipio\Schema\Contracts\DigitalDocumentPermissionContract[] $hasDigitalDocumentPermission
     *
     * @return static
     *
