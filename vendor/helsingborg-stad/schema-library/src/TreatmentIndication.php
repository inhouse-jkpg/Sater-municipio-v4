...
use \Municipio\Schema\Contracts\TreatmentIndicationContract;
 ...
 *
 */
class TreatmentIndication extends BaseType implements TreatmentIndicationContract, MedicalEntityContract, MedicalIndicationContract, ThingContract
{
    /**
