...
use \Municipio\Schema\Contracts\MobilePhoneStoreContract;
 ...
 *
 */
class MobilePhoneStore extends BaseType implements MobilePhoneStoreContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
