...
use \Municipio\Schema\Contracts\RecommendedDoseScheduleContract;
use \Municipio\Schema\Contracts\DoseScheduleContract;
...
class RecommendedDoseSchedule extends BaseType implements RecommendedDoseScheduleContract, DoseScheduleContract, MedicalEntityContract, MedicalIntangibleContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\QualitativeValueContract|\Municipio\Schema\Contracts\QualitativeValueContract[]|float|float[]|int|int[] $doseValue
     *
     * @return static
     *
