...
use \Municipio\Schema\Contracts\RadioStationContract;
 ...
 *
 */
class RadioStation extends BaseType implements RadioStationContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
