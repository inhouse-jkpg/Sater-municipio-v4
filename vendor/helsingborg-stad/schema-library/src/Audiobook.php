...
use \Municipio\Schema\Contracts\AudiobookContract;
use \Municipio\Schema\Contracts\AudioObjectContract;
use \Municipio\Schema\Contracts\BookContract;
...
class Audiobook extends BaseType implements AudiobookContract, AudioObjectContract, BookContract, CreativeWorkContract, MediaObjectContract, ThingContract
{
    ...
    {
        return $this->setProperty('abridged', $abridged);
    }
     ...
     *
     * @param \Municipio\Schema\Contracts\BookFormatTypeContract|\Municipio\Schema\Contracts\BookFormatTypeContract[] $bookFormat
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $illustrator
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\PersonContract|\Municipio\Schema\Contracts\PersonContract[] $readBy
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('readBy', $readBy);
    }
