...
use \Municipio\Schema\Contracts\WatchActionContract;
 ...
 *
 */
class WatchAction extends BaseType implements WatchActionContract, ActionContract, ConsumeActionContract, ThingContract
{
    /**
