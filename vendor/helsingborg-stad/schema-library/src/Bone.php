...
use \Municipio\Schema\Contracts\BoneContract;
 ...
 *
 */
class Bone extends BaseType implements BoneContract, AnatomicalStructureContract, MedicalEntityContract, ThingContract
{
    /**
