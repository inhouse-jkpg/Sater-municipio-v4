...
use \Municipio\Schema\Contracts\GeoCircleContract;
use \Municipio\Schema\Contracts\GeoShapeContract;
...
class GeoCircle extends BaseType implements GeoCircleContract, GeoShapeContract, IntangibleContract, StructuredValueContract, ThingContract
{
     ...
     * used.
     *
     * @param \Municipio\Schema\Contracts\CountryContract|\Municipio\Schema\Contracts\CountryContract[]|string|string[] $addressCountry
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\GeoCoordinatesContract|\Municipio\Schema\Contracts\GeoCoordinatesContract[] $geoMidpoint
     *
     * @return static
     *
     ...
     *
     * @param \Municipio\Schema\Contracts\DistanceContract|\Municipio\Schema\Contracts\DistanceContract[]|float|float[]|int|int[]|string|string[] $geoRadius
     *
     * @return static
     *
