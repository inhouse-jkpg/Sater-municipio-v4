...
use \Municipio\Schema\Contracts\UserReviewContract;
 ...
 *
 */
class UserReview extends BaseType implements UserReviewContract, CreativeWorkContract, ReviewContract, ThingContract
{
    /**
