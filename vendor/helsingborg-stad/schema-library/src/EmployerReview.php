...
use \Municipio\Schema\Contracts\EmployerReviewContract;
 ...
 *
 */
class EmployerReview extends BaseType implements EmployerReviewContract, CreativeWorkContract, ReviewContract, ThingContract
{
    /**
