...
use \Municipio\Schema\Contracts\PreventionIndicationContract;
use \Municipio\Schema\Contracts\MedicalEntityContract;
use \Municipio\Schema\Contracts\MedicalIndicationContract;
 ...
 *
 */
class PreventionIndication extends BaseType implements PreventionIndicationContract, MedicalEntityContract, MedicalIndicationContract, ThingContract
{
    /**
