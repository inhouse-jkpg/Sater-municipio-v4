...
use \Municipio\Schema\Contracts\SuperficialAnatomyContract;
...
class SuperficialAnatomy extends BaseType implements SuperficialAnatomyContract, MedicalEntityContract, ThingContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\AnatomicalStructureContract|\Municipio\Schema\Contracts\AnatomicalStructureContract[]|\Municipio\Schema\Contracts\AnatomicalSystemContract|\Municipio\Schema\Contracts\AnatomicalSystemContract[] $relatedAnatomy
     *
     * @return static
     *
