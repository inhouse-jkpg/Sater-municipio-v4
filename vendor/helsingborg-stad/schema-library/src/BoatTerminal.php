...
use \Municipio\Schema\Contracts\BoatTerminalContract;
 ...
 *
 */
class BoatTerminal extends BaseType implements BoatTerminalContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
