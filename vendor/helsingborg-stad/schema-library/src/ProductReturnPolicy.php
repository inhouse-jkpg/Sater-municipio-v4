...
use \Municipio\Schema\Contracts\ProductReturnPolicyContract;
 ...
 *
 */
class ProductReturnPolicy extends BaseType implements ProductReturnPolicyContract, IntangibleContract, ThingContract
{
    /**
    ...
    {
        return $this->setProperty('productReturnDays', $productReturnDays);
    }
    ...
    {
        return $this->setProperty('productReturnLink', $productReturnLink);
    }
