...
use \Municipio\Schema\Contracts\TextObjectContract;
 ...
 *
 */
class TextObject extends BaseType implements TextObjectContract, CreativeWorkContract, MediaObjectContract, ThingContract
{
    /**
