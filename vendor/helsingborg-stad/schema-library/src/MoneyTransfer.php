...
use \Municipio\Schema\Contracts\MoneyTransferContract;
...
class MoneyTransfer extends BaseType implements MoneyTransferContract, ActionContract, ThingContract, TransferActionContract
{
     ...
     *
     * @param \Municipio\Schema\Contracts\BankOrCreditUnionContract|\Municipio\Schema\Contracts\BankOrCreditUnionContract[]|string|string[] $beneficiaryBank
     *
     * @return static
     *
    ...
    {
        return $this->setProperty('beneficiaryBank', $beneficiaryBank);
    }
