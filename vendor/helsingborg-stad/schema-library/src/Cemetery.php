...
use \Municipio\Schema\Contracts\CemeteryContract;
 ...
 *
 */
class Cemetery extends BaseType implements CemeteryContract, CivicStructureContract, PlaceContract, ThingContract
{
    /**
