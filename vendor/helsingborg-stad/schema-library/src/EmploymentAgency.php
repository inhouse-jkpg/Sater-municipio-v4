...
use \Municipio\Schema\Contracts\EmploymentAgencyContract;
 ...
 *
 */
class EmploymentAgency extends BaseType implements EmploymentAgencyContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
