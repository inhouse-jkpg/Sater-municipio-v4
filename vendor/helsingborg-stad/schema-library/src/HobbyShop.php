...
use \Municipio\Schema\Contracts\HobbyShopContract;
 ...
 *
 */
class HobbyShop extends BaseType implements HobbyShopContract, LocalBusinessContract, OrganizationContract, PlaceContract, StoreContract, ThingContract
{
    /**
