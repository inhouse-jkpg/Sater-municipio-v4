...
use \Municipio\Schema\Contracts\DryCleaningOrLaundryContract;
 ...
 *
 */
class DryCleaningOrLaundry extends BaseType implements DryCleaningOrLaundryContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
