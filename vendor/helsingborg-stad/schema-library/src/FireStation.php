...
use \Municipio\Schema\Contracts\FireStationContract;
 ...
 *
 */
class FireStation extends BaseType implements FireStationContract, CivicStructureContract, EmergencyServiceContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
