...
(function ($) {
    ...
    wpmfFoldersFiltersModule = {
        ...
        clearFilters: function clearFilters() {
            $(['wpmf_post_mime_type', 'wpmf_wpmf_date', 'wpmf_wpmf_size', 'wpmf_wpmf_weight', 'media-order-folder', 'media-order-media', 'wpmf-display-media-filters', 'wpmf_all_media']).each(function () {
            ...
            if (wpmfFoldersModule.page_type !== 'upload-list') {
                ...
                $('.attachment_types, .attachment_dates').val('');
