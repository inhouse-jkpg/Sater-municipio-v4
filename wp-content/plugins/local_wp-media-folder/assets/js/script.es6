...
<div class="ju-settings-option folder_permission_item folder_permission_inherit_folder_item">
        ...
        initializeDragAndDropAttachments: function () {
            ...
            let order_folder = wpmfFoldersModule.getCookie('media-order-folder' + wpmf.vars.host);
            if (typeof order_folder === "undefined") {
                order_folder = 'name-ASC';
            }

            let order_media = wpmfFoldersModule.getCookie('media-order-media' + wpmf.vars.host);
