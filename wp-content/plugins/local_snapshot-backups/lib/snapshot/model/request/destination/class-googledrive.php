...
class Googledrive extends Model\Request\Destination {
	...
	public static function create_oauth_link() {
		...
		// Todo: remove this app when we're ready for new app in next sprint :)
		$client->setClientId( '632110916777-rc8t4tn0jf4heaiv4ln0ml3b87clmhod.apps.googleusercontent.com' );

		// New client ID. Reverted back because of some issues with the new APP settings.
		// $client->setClientId( '632110916777-rduau6t91gpfaflekthq6p3ahfa9tbpo.apps.googleusercontent.com' );
