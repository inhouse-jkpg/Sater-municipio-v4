...
class Admin extends Controller {
	...
	public function add_shared_dependencies() {
		...
		wp_enqueue_style( 'snapshot', $assets->get_asset( 'css/snapshot.css' ), [], SNAPSHOT_BACKUPS_VERSION );
		...
		$this->localized_messages['auth_method_invalid'] = $hide_doc_link
			...
			: __( 'You are currently using Google Account as your preferred login method. Please try to re-authenticate using your Google Account. Or, if you wish to change the login method, you can change it from <a href="https://wpmudev.com/hub2/account/details" target="_blank">your accounts</a> page.', 'snapshot' );
