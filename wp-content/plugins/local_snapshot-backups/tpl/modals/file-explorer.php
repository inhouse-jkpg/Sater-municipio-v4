			...
			<div class="sui-box-body">
				...
				<div class="snapshot-modal--file__explorer__content">
					...
					<ul class="sui-tree" data-tree="directory" role="tree">
						<li class="is-browsable node-type--dir node--enabled" data-root="true" data-path="<?php echo esc_attr( strip_tags( $details['path'] ) ); ?>" data-name="<?php echo esc_attr( $details['name'] ); ?>" data-type="<?php echo esc_attr( $details['type'] ); ?>" role="treeitem" aria-expanded="false" aria-selected="false">
							<span class="sui-tree-node">
								...
								<span class="sui-node-text">
									<?php echo sanitize_file_name( esc_html( $details['name'] ) ); ?>
								</span>
							</span>
						</li>
					</ul>
