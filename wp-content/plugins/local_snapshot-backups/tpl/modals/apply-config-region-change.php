<div class="sui-modal sui-modal-sm">
	<div
		role="dialog"
		id="snapshot-configs-apply-region-change-modal"
				...
				<div id="sui-apply-modal-warning" class="sui-notice sui-active sui-notice-warning">
					<div class="sui-notice-content">
						<div class="sui-notice-message">
							...
							<p><?php esc_html_e( 'The storage region in the selected config doesn\'t match the storage region in your current settings. All existing backups will be deleted after applying this config.', 'snapshot' ); ?></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="sui-box-footer sui-content-center sui-flatten sui-spacing-top--0 sui-spacing-bottom--60">
				...
				<button class="sui-button snapshot-apply-config__confirm-region-change sui-button-blue">
					<span class="sui-loading-text">
						<span class="sui-icon-check" aria-hidden="true"></span> <?php esc_html_e( 'Apply', 'snapshot' ); ?>
					</span>
