		...
		<div class="sui-box snapshot-list-backups">
			...
			<div class="sui-box-body snapshot-no-backups">
				<div class="sui-message">
					...
					<img class="snapshot-no-backups-hero <?php echo ! empty( $is_branding_hidden ) ? esc_html( 'snapshot-hidden-branding' ) : esc_html( '' ); ?>" src="<?php echo esc_attr( $assets->get_asset( 'img/no-backups-icon.svg' ) ); ?>"
						class="sui-image"
						aria-hidden="true" />
					...
					<div class="sui-box-settings-col-2 snapshot-exclusions-settings-box" >
						...
						<div class="snapshot-global-exclusions-field">
							...
							<div class="sui-form-field">
								...
								><?php echo esc_html( $global_exclusions ); ?></textarea>
