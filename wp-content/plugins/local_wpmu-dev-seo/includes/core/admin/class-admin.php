...
class Admin extends Controllers\Controller {
	...
	protected function init() {
		...
		if ( Settings::get_setting( 'extras-admin_bar' ) ) {
		...
		$this->handlers['onpage']    = Admin_Settings\Onpage::get();
		$this->handlers['schema']    = Admin_Settings\Schema::get();
		$this->handlers['social']    = Admin_Settings\Social::get();
		$this->handlers['sitemap']   = Admin_Settings\Sitemap::get();
		$this->handlers['autolinks'] = Admin_Settings\Advanced::get();
