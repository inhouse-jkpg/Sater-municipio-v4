...
class CacheBust
{
    ...
    {
        $jsonPath = ACFOPENSTREETMAP_PATH . apply_filters(
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . ACFOPENSTREETMAP_PATH . ' and run gulp. See ' . ACFOPENSTREETMAP_PATH . 'README.md for more info.</div>';
        }
