...
namespace ModularityLatestNews\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITYLATEST_NEWS_PATH . apply_filters(
            'ModularityLatestNews/Helper/CacheBust/RevManifestPath',
            'dist/manifest.json'
        );
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITYLATEST_NEWS_PATH . ' and run gulp. See ' . MODULARITYLATEST_NEWS_PATH . 'README.md for more info.</div>';
        }
    }
}
